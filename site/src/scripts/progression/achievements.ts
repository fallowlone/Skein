...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: "rank-engineer", icon: "🛠️", xp: 30, label: { en: "Engineer", ru: "Инженер" }, desc: { en: "Reach the Engineer tier", ru: "Достичь тира «Инженер»" }, predicate: (s) => (s.progression.peakRating ?? s.pretest?.rating ?? 0) >= 450 },
  { id: "rank-senior", icon: "🧭", xp: 60, label: { en: "Made Senior", ru: "Дорос до senior" }, desc: { en: "Reach the Staff tier (senior)", ru: "Достичь тира Staff (сеньор)" }, predicate: (s) => (s.progression.peakRating ?? s.pretest?.rating ?? 0) >= 750 },
  { id: "rank-architect", icon: "🏛️", xp: 90, label: { en: "Architect", ru: "Архитектор" }, desc: { en: "Reach the Architect tier", ru: "Достичь тира «Архитектор»" }, predicate: (s) => (s.progression.peakRating ?? s.pretest?.rating ?? 0) >= 930 },
  { id: "distinguished", icon: "👑", xp: 150, label: { en: "Distinguished", ru: "Эксперт" }, desc: { en: "Reach the apex rank", ru: "Достичь апекс-ранга" }, predicate: (s) => (s.progression.peakRating ?? s.pretest?.rating ?? 0) >= 990 },
