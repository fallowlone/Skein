...
order: 101
title: "Coding Quiz"
summary: "Coding Quiz for unit "Trace propagation: the headers that stitch services together""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the Trace propagation: the headers that stitch services together unit.
</Hook>
