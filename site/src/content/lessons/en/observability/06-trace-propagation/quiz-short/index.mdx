...
summary: "Short Answer Quiz for unit "Trace propagation: the headers that stitch services together""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Trace propagation: the headers that stitch services together unit.
</Hook>
