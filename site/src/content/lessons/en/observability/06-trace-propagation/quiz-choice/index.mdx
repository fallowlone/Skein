...
summary: "Multiple Choice Quiz for unit "Trace propagation: the headers that stitch services together""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Trace propagation: the headers that stitch services together unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Trace propagation: the headers that stitch services together unit.
</Goal>
