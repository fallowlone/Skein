...
summary: "Short Answer Quiz for unit "Profiling: where the CPU and the bytes actually went""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Profiling: where the CPU and the bytes actually went unit.
</Hook>
