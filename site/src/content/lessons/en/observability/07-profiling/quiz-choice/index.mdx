...
summary: "Multiple Choice Quiz for unit "Profiling: where the CPU and the bytes actually went""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Profiling: where the CPU and the bytes actually went unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Profiling: where the CPU and the bytes actually went unit.
</Goal>
