...
order: 101
title: "Coding Quiz"
summary: "Coding Quiz for unit "Profiling: where the CPU and the bytes actually went""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the Profiling: where the CPU and the bytes actually went unit.
</Hook>
