...
summary: "Project Testing for unit "Profiling: where the CPU and the bytes actually went""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Profiling: where the CPU and the bytes actually went unit.
</Hook>
