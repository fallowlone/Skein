...
summary: "Multiple Choice Quiz for unit "SLI, SLO, and error budgets: reliability in numbers""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the SLI, SLO, and error budgets: reliability in numbers unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the SLI, SLO, and error budgets: reliability in numbers unit.
</Goal>
