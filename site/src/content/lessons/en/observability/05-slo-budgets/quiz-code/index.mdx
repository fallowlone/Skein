...
order: 101
title: "Coding Quiz"
summary: "Coding Quiz for unit "SLI, SLO, and error budgets: reliability in numbers""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the SLI, SLO, and error budgets: reliability in numbers unit.
</Hook>
