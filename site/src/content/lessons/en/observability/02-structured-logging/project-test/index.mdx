...
- https://example.com
status: ready
summary: 'Project Testing for unit "Structured logging: schema, levels, redaction"'
...
<Hook>
This is a project-test for the Structured logging: schema, levels, redaction unit.
</Hook>
