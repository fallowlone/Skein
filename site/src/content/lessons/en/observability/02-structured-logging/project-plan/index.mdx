...
- https://example.com
status: ready
summary: 'Project Planning for unit "Structured logging: schema, levels, redaction"'
...
<Hook>
This is a project-plan for the Structured logging: schema, levels, redaction unit.
</Hook>
