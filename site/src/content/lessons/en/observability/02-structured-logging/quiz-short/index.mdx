...
- https://example.com
status: stub
summary: 'Short Answer Quiz for unit "Structured logging: schema, levels, redaction"'
...
<Hook>
This is a quiz-short for the Structured logging: schema, levels, redaction unit.
</Hook>
