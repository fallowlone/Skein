...
- https://example.com
status: ready
summary: 'Project Building for unit "Structured logging: schema, levels, redaction"'
...
<Hook>
This is a project-build for the Structured logging: schema, levels, redaction unit.
</Hook>
