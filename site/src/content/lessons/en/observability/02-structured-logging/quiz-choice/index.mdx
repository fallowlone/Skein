...
- https://example.com
status: stub
summary: 'Multiple Choice Quiz for unit "Structured logging: schema, levels, redaction"'
...
<Hook>
This is a quiz-choice for the Structured logging: schema, levels, redaction unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Structured logging: schema, levels, redaction unit.
</Goal>
