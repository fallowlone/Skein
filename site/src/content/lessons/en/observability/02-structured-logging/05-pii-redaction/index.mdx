...
summary: "Logs are the easiest signal to leak sensitive data into and the hardest to clean up. Redact at the source, defend in depth at the collector, and never interpolate user input into log messages."
estMin: 12
status: ready
lessonType: topic
level: senior
