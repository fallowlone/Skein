...
- https://example.com
status: stub
summary: 'Coding Quiz for unit "Putting it together: a production observability story"'
title: Coding Quiz
track: observability
...
<Hook>
This is a quiz-code for the Putting it together: a production observability story unit.
</Hook>
