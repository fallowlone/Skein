...
summary: "Multiple Choice Quiz for unit "Putting it together: a production observability story""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Putting it together: a production observability story unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Putting it together: a production observability story unit.
</Goal>
