...
- https://example.com
status: stub
summary: 'Multiple Choice Quiz for unit "Three pillars: metrics, logs, and traces"'
...
<Hook>
This is a quiz-choice for the Three pillars: metrics, logs, and traces unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Three pillars: metrics, logs, and traces unit.
</Goal>
