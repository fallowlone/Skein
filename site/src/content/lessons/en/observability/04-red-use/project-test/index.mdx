...
summary: "Project Testing for unit "RED and USE: the two halves of every dashboard""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the RED and USE: the two halves of every dashboard unit.
</Hook>
