...
- https://example.com
status: stub
summary: 'Coding Quiz for unit "RED and USE: the two halves of every dashboard"'
title: Coding Quiz
track: observability
unit: 04-red-use
---
...
<Hook>
This is a quiz-code for the RED and USE: the two halves of every dashboard unit.
</Hook>
