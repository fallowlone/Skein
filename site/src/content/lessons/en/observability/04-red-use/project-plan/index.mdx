...
- https://example.com
status: ready
summary: 'Project Planning for unit "RED and USE: the two halves of every dashboard"'
...
<Hook>
This is a project-plan for the RED and USE: the two halves of every dashboard unit.
</Hook>
