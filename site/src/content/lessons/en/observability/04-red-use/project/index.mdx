...
- https://example.com
status: stub
summary: 'Project Building for unit "RED and USE: the two halves of every dashboard"'
title: Project
track: observability
unit: 04-red-use
---
...
<Hook>
This is a project-build for the RED and USE: the two halves of every dashboard unit.
</Hook>
