...
import timeBudget from "./infographics/time-budget.svg?raw";
...
<Infographic
  svg={timeBudget}
  label="Donut chart splitting a roughly 30-minute design phase: about 3 minutes for the high-level design and about 27 minutes for the deep-dive."
  caption="The HLD is a couple of minutes of almost-boring composition; the bulk of the session goes to the one or two genuinely hard components. The interview is won in that larger slice."
  hue="var(--d-infra)"
/>
