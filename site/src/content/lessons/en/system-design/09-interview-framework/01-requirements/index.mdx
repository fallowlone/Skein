...
Split requirements into two piles, because they constrain the design in different ways.
...
Stating these out loud is not pedantry — each number is a lever that turns one architecture on and another off, and naming them is how you and the interviewer agree on which system you're actually building.
