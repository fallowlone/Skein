...
<Infographic
  svg={precisionLadder}
  label="A funnel of four geohash prefix lengths narrowing step by step: 4 characters is a cell of about 40 km, 5 characters about 5 km, 6 characters about 1 km, and 7 characters about 150 m — each added character shrinks the cell roughly 32 times in area."
  caption="Length is the precision dial: every extra character narrows the cell ~32×, so a longer shared prefix pins two points into a smaller cell and means they are physically closer."
  hue="var(--d-infra)"
/>
