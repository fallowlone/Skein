...
<Infographic
  ...
  label="Column chart of the conditional-type recursion ceiling: non-tail recursive infer chains stop at about 50 instantiation levels, while tail-recursive forms reach roughly 1000."
  caption="Rewriting a recursive infer into tail-recursive form buys roughly 20x more depth before TypeScript bails to a silent any — the difference between a 50-deep wall and a ~1000-deep one."
  hue="var(--d-infra)"
/>
