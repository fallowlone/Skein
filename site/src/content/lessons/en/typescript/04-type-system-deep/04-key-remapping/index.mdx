...
import unionBlowup from "./infographics/union-blowup.svg?raw";
...
<Infographic
  svg={unionBlowup}
  label="Ascending steps showing how a template-literal rename multiplies key sets: one 50-key source is a 50-member union, two crossed sets are 2,500, three are 125,000 — past TypeScript's ~100,000-member union cap."
  caption="Each key axis you cross-multiply in the as clause is a factor, not a sum: 50 to 2,500 to 125,000. The third axis blows past the ~100,000-member cap and tsc gives up — keep the rename's input sets small."
  hue="var(--d-infra)"
/>
