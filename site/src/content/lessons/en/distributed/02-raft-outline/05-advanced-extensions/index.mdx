...
summary: "Four production-critical Raft extensions — pre-vote to prevent term inflation, learners for safe scale-out, snapshots for log compaction, and ReadIndex/lease reads for fast linearizable queries."
estMin: 16
status: ready
lessonType: topic
level: senior
...
spiral: ["statefulness"]
concepts: ["pre-vote", "learner", "install-snapshot", "readindex", "leader-lease", "log-compaction"]
sources:
