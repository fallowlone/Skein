...
summary: "Joint consensus for safe membership change, Multi-Raft sharding patterns, leadership transfer for rolling deploys, the minimum viable Raft dashboard, and three real production postmortems."
estMin: 16
status: ready
lessonType: topic
level: senior
