...
summary: "Multiple Choice Quiz for unit "TDD and property-based testing""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the TDD and property-based testing unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the TDD and property-based testing unit.
</Goal>
