...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "Trunk-based development"
...
<Hook>
This is a quiz-choice for the Trunk-based development unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Trunk-based development unit.
</Goal>
