...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "Contract testing"
...
<Hook>
This is a quiz-choice for the Contract testing unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Contract testing unit.
</Goal>
