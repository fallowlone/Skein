...
<Crux>'use server' compiles a function into a POST endpoint addressed by an action id. Forms invoke it pre-hydration; args cross the wire — so validate and authorize inside the action, then revalidate.</Crux>
