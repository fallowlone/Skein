...
<Crux>Folders define routes; special files define UI. A layout persists across navigation — it does not re-render; page is the leaf, loading is a Suspense boundary, error a client error boundary.</Crux>
