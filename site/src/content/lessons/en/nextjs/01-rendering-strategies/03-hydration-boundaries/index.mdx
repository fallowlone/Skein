...
<Crux>Hydration attaches listeners to server HTML by re-rendering and matching it. Any server/client difference (time, locale, browser-only state) breaks the match — React recovers by re-rendering from scratch, twice the work.</Crux>
