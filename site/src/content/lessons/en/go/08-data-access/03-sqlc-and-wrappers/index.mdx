...
Every Go data layer sits somewhere on a four-point spectrum, and each point has a real cost — the dishonest move is pretending yours does not.
...
You write queries in a `.sql` file, each with a name and a cardinality annotation:
