...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "Message ordering guarantees"
...
<Hook>
This is a quiz-choice for the Message ordering guarantees unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Message ordering guarantees unit.
</Goal>
