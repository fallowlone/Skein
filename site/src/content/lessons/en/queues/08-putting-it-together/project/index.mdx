...
- https://example.com
status: stub
summary: 'Project Building for unit "Putting it together: event-driven service mesh"'
title: Project
track: queues
...
<Hook>
This is a project-build for the Putting it together: event-driven service mesh unit.
</Hook>
