...
- https://example.com
status: stub
summary: 'Coding Quiz for unit "Putting it together: event-driven service mesh"'
title: Coding Quiz
track: queues
...
<Hook>
This is a quiz-code for the Putting it together: event-driven service mesh unit.
</Hook>
