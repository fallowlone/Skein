...
- https://example.com
status: ready
summary: 'Project Planning for unit "Putting it together: event-driven service mesh"'
...
<Hook>
This is a project-plan for the Putting it together: event-driven service mesh unit.
</Hook>
