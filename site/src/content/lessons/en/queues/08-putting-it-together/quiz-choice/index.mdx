...
summary: "Multiple Choice Quiz for unit "Putting it together: event-driven service mesh""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Putting it together: event-driven service mesh unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Putting it together: event-driven service mesh unit.
</Goal>
