...
- https://example.com
status: ready
summary: 'Project Testing for unit "Putting it together: event-driven service mesh"'
...
<Hook>
This is a project-test for the Putting it together: event-driven service mesh unit.
</Hook>
