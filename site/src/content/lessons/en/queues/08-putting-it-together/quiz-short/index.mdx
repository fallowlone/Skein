...
summary: "Short Answer Quiz for unit "Putting it together: event-driven service mesh""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Putting it together: event-driven service mesh unit.
</Hook>
