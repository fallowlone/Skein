...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "RabbitMQ exchanges and routing"
...
<Hook>
This is a quiz-choice for the RabbitMQ exchanges and routing unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the RabbitMQ exchanges and routing unit.
</Goal>
