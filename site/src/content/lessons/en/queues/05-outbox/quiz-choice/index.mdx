...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "The transactional outbox pattern"
...
<Hook>
This is a quiz-choice for the The transactional outbox pattern unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the The transactional outbox pattern unit.
</Goal>
