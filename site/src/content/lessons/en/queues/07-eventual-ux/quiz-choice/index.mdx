...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "Designing UX for eventual consistency"
...
<Hook>
This is a quiz-choice for the Designing UX for eventual consistency unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Designing UX for eventual consistency unit.
</Goal>
