...
summary: "The cost of an algorithm is how many basic operations it performs. Count the steps for a given input size n, and see how the count grows as n grows."
estMin: 18
status: ready
