...
summary: "Before solving a problem, look at the input limits. Learn the rule of thumb (10⁸ operations per second), the standard mapping from input size to required complexity, and how to use constraints to eliminate impossible approaches."
estMin: 16
status: ready
