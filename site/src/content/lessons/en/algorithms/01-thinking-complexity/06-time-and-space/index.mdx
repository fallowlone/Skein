...
summary: "Until now, complexity meant time. But every algorithm also costs memory. Learn to measure space complexity — how much extra memory an algorithm uses — and the deliberate tradeoff between time and space."
estMin: 18
status: ready
prereqs: ["05-complexity-classes"]
mathPrereqs: []
concepts: ["space_complexity", "auxiliary_space", "time_space_tradeoff", "call_stack"]
sources:
