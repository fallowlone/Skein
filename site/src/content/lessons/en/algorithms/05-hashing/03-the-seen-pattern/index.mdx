...
summary: "Keep a hash set of values you have seen. For each new element, check the set in O(1), then add it. One pass solves what O(n²) brute force once required."
estMin: 18
status: ready
