...
<AlgoPoster
  ...
  pattern="buckets"
  data={{ title: "h=first % 5: 0,0,1,1", nb: 5, keys: ["Alice", "April", "Bob", "Ben"], to: [0, 0, 1, 1], placed: [1, 2, 4, 4], hi: [0, 1, 2, 3], hlabels: ["h=0", "h=0", "h=1", "h=1"], note: "bucket 0 = chain Alice → April" }}
  steps={[
