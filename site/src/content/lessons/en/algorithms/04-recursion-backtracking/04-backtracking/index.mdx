...
order: 4
title: "Backtracking"
summary: "Backtracking systematically explores all candidate solutions by building them step by step. At each step, you make a choice, recurse, then undo the choice before trying the next. If a partial solution violates a constraint, prune that branch and skip the rest."
estMin: 20
status: ready
