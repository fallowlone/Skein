...
order: 6
title: "Combinations"
summary: "Generate every way to choose k items from n items, where order does not matter. Use the start index trick: walk items in fixed order and at each step choose to include or skip, never revisiting earlier items. Leads to C(n,k) = n! / (k!(n-k)!) combinations."
estMin: 18
status: ready
prereqs: ["05-subsets-and-permutations"]
mathPrereqs: ["math/09-combinatorics/03-combinations"]
concepts: ["combination", "start_index", "binomial_coefficient"]
sources:
