...
order: 5
title: "Prefix sums"
summary: "Precompute a prefix array once. Then any range-sum query costs O(1) by subtraction instead of O(n) by traversal. Trade O(n) memory and setup for instant answers."
estMin: 18
status: ready
prereqs: ["02-traversal"]
mathPrereqs: []
concepts: ["prefix_sum", "prefix_array", "range_query", "precomputation"]
sources:
