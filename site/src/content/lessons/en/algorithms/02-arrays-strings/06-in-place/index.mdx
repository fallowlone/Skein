...
summary: "Modify an array without building a new one. Use O(1) extra space by overwriting cells in place: swap two elements, use a write pointer to compact an array, or reverse using two opposite-end pointers. In-place saves memory but destroys the original input."
estMin: 17
status: ready
