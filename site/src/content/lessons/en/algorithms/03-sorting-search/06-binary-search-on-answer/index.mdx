...
<AlgoPoster
  ...
  label="Animated candidate strip 10, 12, 14, 15, 21, 32, 55 with answer 15 starred. The bracket collapses from the full range to [10,15] to [14,15] to [15,15] as infeasible mids push lo right and feasible mids pull hi left."
  pattern="halving"
  data={{ title: "capacity flip at 15", cells: ["10", "12", "14", "15", "21", "32", "55"], ranges: [[0, 6], [0, 3], [2, 3], [3, 3]], target: 3 }}
  steps={[
    { caption: "① [10,55]: mid 15 ships in 5 days — feasible, try smaller…", state: "STATE: feasible hi 15", log: "mid=15 · days 5 ≤ 5 · hi=15" },
    { caption: "② [10,15]: mid 12 needs 6 days — infeasible, go larger…", state: "STATE: infeasible lo 13", log: "mid=12 · days 6 > 5 · lo=13" },
    { caption: "③ [14,15]: mid 14 needs 6 days — infeasible, go larger…", state: "STATE: lo 15 hi 15", log: "mid=14 · days 6 > 5 · lo=15" },
    { caption: "④ lo = hi = 15: the smallest feasible capacity…", state: "STATE: ANSWER 15", log: "✓ answer 15 · O(n log sum)" }
  ]}
  minis={[
