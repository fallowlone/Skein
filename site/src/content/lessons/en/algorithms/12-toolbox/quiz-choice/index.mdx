...
summary: "Multiple Choice Quiz for unit "Problem-solving toolbox""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Problem-solving toolbox unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Problem-solving toolbox unit.
</Goal>
