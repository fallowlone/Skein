...
summary: "Multiple Choice Quiz for unit "Greedy algorithms""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Greedy algorithms unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Greedy algorithms unit.
</Goal>
