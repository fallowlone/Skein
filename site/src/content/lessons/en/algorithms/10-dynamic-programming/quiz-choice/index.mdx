...
summary: "Multiple Choice Quiz for unit "Dynamic programming""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Dynamic programming unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Dynamic programming unit.
</Goal>
