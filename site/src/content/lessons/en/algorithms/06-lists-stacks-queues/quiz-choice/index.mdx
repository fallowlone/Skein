...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "Linked lists, stacks, queues"
...
<Hook>
This is a quiz-choice for the Linked lists, stacks, queues unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Linked lists, stacks, queues unit.
</Goal>
