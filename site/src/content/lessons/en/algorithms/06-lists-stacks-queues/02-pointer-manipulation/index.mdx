...
summary: "Insert a node into a linked list, delete a node, and reverse the list using pointer updates. Learn the dummy-head (sentinel) pattern to eliminate edge cases and write cleaner code."
estMin: 22
status: ready
