...
summary: "A queue: FIFO container where you enqueue at the rear, dequeue from the front. Both O(1) with proper implementation. A deque extends this to support O(1) at both ends, used in BFS and any situation requiring fairness."
estMin: 24
status: ready
