...
summary: "Multiple Choice Quiz for unit "Heaps and priority queues""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Heaps and priority queues unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Heaps and priority queues unit.
</Goal>
