...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "Trees"
...
<Hook>
This is a quiz-choice for the Trees unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Trees unit.
</Goal>
