...
summary: "You can't ship an LLM feature without evals: the same input gives different output, and a model or prompt change silently regresses quality. Golden sets, programmatic checks, and a validated judge are how you catch it before users do."
prereqs: []
deepensInto: []
spiral: []
concepts: ["golden-dataset", "llm-as-judge", "offline-eval", "online-eval", "regression-gate", "distribution-drift"]
estMin: 17
sources:
