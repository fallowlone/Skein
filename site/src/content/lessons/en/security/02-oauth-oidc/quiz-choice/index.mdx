...
summary: "Multiple Choice Quiz for unit "OAuth 2.1 and OIDC: delegated authorization that does not leak""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the OAuth 2.1 and OIDC: delegated authorization that does not leak unit.
</Hook>
