...
summary: "Project Planning for unit "OAuth 2.1 and OIDC: delegated authorization that does not leak""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the OAuth 2.1 and OIDC: delegated authorization that does not leak unit.
</Hook>
