...
summary: "Why bearer tokens fail under XSS or supply-chain attack, how DPoP binds a token to a client-held key, and when to use mTLS-bound tokens instead — with FAPI 2.0 requirements."
estMin: 11
status: ready
lessonType: topic
level: senior
...
concepts: ["dpop", "mtls", "sender-constrained", "fapi", "par", "jar", "cnf", "jkt"]
sources:
