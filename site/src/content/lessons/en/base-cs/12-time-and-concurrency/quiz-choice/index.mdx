...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "Time and concurrency"
...
<Hook>
This is a quiz-choice for the Time and concurrency unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Time and concurrency unit.
</Goal>
