...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "From machine code to a language"
...
<Hook>
This is a quiz-choice for the From machine code to a language unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the From machine code to a language unit.
</Goal>
