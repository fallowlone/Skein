...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "Values and types"
...
<Hook>
This is a quiz-choice for the Values and types unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Values and types unit.
</Goal>
