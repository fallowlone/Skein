...
summary: "Multiple Choice Quiz for unit "Abstraction""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Abstraction unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Abstraction unit.
</Goal>
