...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "Control flow"
...
<Hook>
This is a quiz-choice for the Control flow unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Control flow unit.
</Goal>
