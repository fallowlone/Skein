...
summary: "Multiple Choice Quiz for unit "Functions and the call stack""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Functions and the call stack unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Functions and the call stack unit.
</Goal>
