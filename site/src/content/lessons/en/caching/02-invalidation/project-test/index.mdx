...
summary: "Project Testing for unit "Cache invalidation: the hardest problem in CS""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Cache invalidation: the hardest problem in CS unit.
</Hook>
