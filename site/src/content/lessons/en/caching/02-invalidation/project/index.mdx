...
- https://example.com
status: stub
summary: 'Project Building for unit "Cache invalidation: the hardest problem in CS"'
title: Project
track: caching
...
<Hook>
This is a project-build for the Cache invalidation: the hardest problem in CS unit.
</Hook>
