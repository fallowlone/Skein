...
summary: "Multiple Choice Quiz for unit "Cache invalidation: the hardest problem in CS""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Cache invalidation: the hardest problem in CS unit.
</Hook>
