...
- https://example.com
status: stub
summary: 'Coding Quiz for unit "Cache invalidation: the hardest problem in CS"'
title: Coding Quiz
track: caching
...
<Hook>
This is a quiz-code for the Cache invalidation: the hardest problem in CS unit.
</Hook>
