...
- https://example.com
status: ready
summary: 'Short Answer Quiz for unit "Cache invalidation: the hardest problem in CS"'
...
<Hook>
This is a quiz-short for the Cache invalidation: the hardest problem in CS unit.
</Hook>
