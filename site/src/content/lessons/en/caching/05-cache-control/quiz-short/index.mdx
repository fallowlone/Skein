...
- https://example.com
status: stub
summary: 'Short Answer Quiz for unit "Cache-Control: directing browsers and CDNs"'
...
<Hook>
This is a quiz-short for the Cache-Control: directing browsers and CDNs unit.
</Hook>
