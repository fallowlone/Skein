...
- https://example.com
status: ready
summary: 'Project Planning for unit "Cache-Control: directing browsers and CDNs"'
...
<Hook>
This is a project-plan for the Cache-Control: directing browsers and CDNs unit.
</Hook>
