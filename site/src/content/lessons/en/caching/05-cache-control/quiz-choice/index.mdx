...
- https://example.com
status: stub
summary: 'Multiple Choice Quiz for unit "Cache-Control: directing browsers and CDNs"'
...
<Hook>
This is a quiz-choice for the Cache-Control: directing browsers and CDNs unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Cache-Control: directing browsers and CDNs unit.
</Goal>
