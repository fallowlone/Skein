...
- https://example.com
status: stub
summary: 'Short Answer Quiz for unit "ETags: conditional requests and zero-byte responses"'
...
<Hook>
This is a quiz-short for the ETags: conditional requests and zero-byte responses unit.
</Hook>
