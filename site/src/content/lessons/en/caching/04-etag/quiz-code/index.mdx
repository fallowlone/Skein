...
- https://example.com
status: ready
summary: 'Coding Quiz for unit "ETags: conditional requests and zero-byte responses"'
title: Coding Quiz
track: caching
unit: 04-etag
---
...
<Hook>
This is a quiz-code for the ETags: conditional requests and zero-byte responses unit.
</Hook>
