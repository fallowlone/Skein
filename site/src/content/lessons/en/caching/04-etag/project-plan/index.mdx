...
summary: "Project Planning for unit "ETags: conditional requests and zero-byte responses""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the ETags: conditional requests and zero-byte responses unit.
</Hook>
