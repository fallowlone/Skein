...
- https://example.com
status: ready
summary: 'Project Testing for unit "ETags: conditional requests and zero-byte responses"'
...
<Hook>
This is a project-test for the ETags: conditional requests and zero-byte responses unit.
</Hook>
