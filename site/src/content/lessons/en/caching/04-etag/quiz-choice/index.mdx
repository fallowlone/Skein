...
summary: "Multiple Choice Quiz for unit "ETags: conditional requests and zero-byte responses""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the ETags: conditional requests and zero-byte responses unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the ETags: conditional requests and zero-byte responses unit.
</Goal>
