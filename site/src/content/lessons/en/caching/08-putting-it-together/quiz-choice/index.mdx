...
summary: "Multiple Choice Quiz for unit "Caching system design: combining all layers""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Caching system design: combining all layers unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Caching system design: combining all layers unit.
</Goal>
