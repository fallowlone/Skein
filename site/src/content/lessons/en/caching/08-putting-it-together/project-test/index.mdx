...
- https://example.com
status: ready
summary: 'Project Testing for unit "Caching system design: combining all layers"'
...
<Hook>
This is a project-test for the Caching system design: combining all layers unit.
</Hook>
