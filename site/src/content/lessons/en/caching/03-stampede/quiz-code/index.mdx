...
order: 101
title: "Coding Quiz"
summary: "Coding Quiz for unit "Cache stampede: when one TTL expires and thousands of requests hit the DB""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the Cache stampede: when one TTL expires and thousands of requests hit the DB unit.
</Hook>
