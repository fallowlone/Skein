...
summary: "Short Answer Quiz for unit "Cache stampede: when one TTL expires and thousands of requests hit the DB""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Cache stampede: when one TTL expires and thousands of requests hit the DB unit.
</Hook>
