...
summary: "Project Building for unit "Cache stampede: when one TTL expires and thousands of requests hit the DB""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-build for the Cache stampede: when one TTL expires and thousands of requests hit the DB unit.
</Hook>
