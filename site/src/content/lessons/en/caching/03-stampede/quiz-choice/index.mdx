...
summary: "Multiple Choice Quiz for unit "Cache stampede: when one TTL expires and thousands of requests hit the DB""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Cache stampede: when one TTL expires and thousands of requests hit the DB unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Cache stampede: when one TTL expires and thousands of requests hit the DB unit.
</Goal>
