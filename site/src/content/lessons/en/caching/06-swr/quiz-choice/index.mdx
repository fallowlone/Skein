...
summary: "Multiple Choice Quiz for unit "Stale-while-revalidate: serve stale, refresh in background""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Stale-while-revalidate: serve stale, refresh in background unit.
</Hook>
