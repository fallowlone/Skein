...
summary: "Project Testing for unit "Stale-while-revalidate: serve stale, refresh in background""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Stale-while-revalidate: serve stale, refresh in background unit.
</Hook>
