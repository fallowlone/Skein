...
summary: "Project Testing for unit "Dogpile effect: concurrent cache misses that crush the origin""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Dogpile effect: concurrent cache misses that crush the origin unit.
</Hook>
