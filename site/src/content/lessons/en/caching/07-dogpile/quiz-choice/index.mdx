...
summary: "Multiple Choice Quiz for unit "Dogpile effect: concurrent cache misses that crush the origin""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Dogpile effect: concurrent cache misses that crush the origin unit.
</Hook>
