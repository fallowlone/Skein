...
order: 101
title: "Coding Quiz"
summary: "Coding Quiz for unit "Dogpile effect: concurrent cache misses that crush the origin""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the Dogpile effect: concurrent cache misses that crush the origin unit.
</Hook>
