...
summary: "Project Building for unit "Dogpile effect: concurrent cache misses that crush the origin""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-build for the Dogpile effect: concurrent cache misses that crush the origin unit.
</Hook>
