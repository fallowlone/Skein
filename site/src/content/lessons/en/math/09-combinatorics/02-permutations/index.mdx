...
order: 2
title: "Permutations"
summary: "A permutation is an arrangement where order matters — count it by multiplying the shrinking number of choices, which is exactly what a factorial does."
estMin: 15
status: ready
prereqs: ["01-counting-principle"]
