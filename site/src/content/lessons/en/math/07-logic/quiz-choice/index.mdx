...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "Logic and sets"
...
<Hook>
This is a quiz-choice for the Logic and sets unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Logic and sets unit.
</Goal>
