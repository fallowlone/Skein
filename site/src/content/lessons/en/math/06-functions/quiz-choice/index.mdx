...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "Functions"
...
<Hook>
This is a quiz-choice for the Functions unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Functions unit.
</Goal>
