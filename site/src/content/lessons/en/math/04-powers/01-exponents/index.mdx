...
status: ready
summary: An exponent is shorthand for multiplying a number by itself again and again
  — and that repeated multiplication makes numbers grow startlingly fast.
title: Exponents
track: math
unit: 04-powers
---
