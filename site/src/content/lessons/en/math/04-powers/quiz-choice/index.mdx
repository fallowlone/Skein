...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "Powers and roots"
...
<Hook>
This is a quiz-choice for the Powers and roots unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Powers and roots unit.
</Goal>
