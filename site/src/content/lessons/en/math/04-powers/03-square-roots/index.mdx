...
order: 3
title: "Square roots"
summary: "Squaring asks what a number times itself comes to; the square root asks the question backwards — what number, squared, gives this?"
estMin: 15
status: ready
prereqs: ["01-exponents"]
concepts: ["square-root", "perfect-square"]
sources:
...
such a root by trapping it between the nearest perfect squares.
</Recap>
