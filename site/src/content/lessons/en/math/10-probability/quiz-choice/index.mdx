...
summary: "Multiple Choice Quiz for unit "Probability""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Probability unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Probability unit.
</Goal>
