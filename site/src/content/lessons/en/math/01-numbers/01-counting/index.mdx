...
the oldest piece of mathematics there is — you count. In ten minutes you will see
exactly why that simple act is the foundation every other number idea is built on.
</Hook>
...
<FlowDiagram
  nodes={[
    { id: "say", label: "Say 'one'", sub: "counting word", col: 0, row: 0 },
    { id: "touch", label: "Touch coin 1", sub: "one object", col: 1, row: 0 },
    { id: "say2", label: "Say 'two'", sub: "next word", col: 2, row: 0 },
    { id: "touch2", label: "Touch coin 2", sub: "next object", col: 3, row: 0 },
    { id: "last", label: "Last word", sub: "= total", col: 1, row: 1 },
    { id: "ans", label: "'Five'", sub: "the answer", col: 2, row: 1 },
  ]}
  edges={[
    { from: "say", to: "touch", label: "land on" },
    { from: "touch", to: "say2", label: "move to next" },
    { from: "say2", to: "touch2", label: "land on" },
    { from: "touch2", to: "last", label: "..." },
    { from: "last", to: "ans" },
  ]}
  label="Counting is one-to-one matching: each number word lands on exactly one object; the last word is the total."
  caption="Any mismatch — counting an object twice, or skipping one — corrupts the total. The bijection between words and objects is the invariant."
...
is counting drawn as a row of evenly spaced spots. Now when you count anything — coins,
steps, items in a list — you know you are doing one of the oldest things in mathematics,
and that the number line is just that same act drawn in a straight line.
</Recap>
