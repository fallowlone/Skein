...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "Variables and algebra"
...
<Hook>
This is a quiz-choice for the Variables and algebra unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Variables and algebra unit.
</Goal>
