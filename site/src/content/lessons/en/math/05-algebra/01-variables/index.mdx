...
order: 1
title: "Variables"
summary: "A variable is a letter standing in for a number — one you have not found yet, or one that is allowed to change."
estMin: 14
status: ready
prereqs: ["02-operations/01-addition"]
...
from the problem you are working on.
</Recap>
