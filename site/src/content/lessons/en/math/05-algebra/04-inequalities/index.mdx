...
order: 4
title: "Inequalities"
summary: "An inequality compares with greater-than or less-than instead of equals — so its answer is not one number but a whole range of them."
estMin: 15
status: ready
prereqs: ["01-numbers/02-comparing", "03-equations"]
concepts: ["inequality", "solution-range"]
sources:
