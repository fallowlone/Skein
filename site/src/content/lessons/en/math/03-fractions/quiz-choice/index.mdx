...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "Fractions, decimals, percents"
...
<Hook>
This is a quiz-choice for the Fractions, decimals, percents unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Fractions, decimals, percents unit.
</Goal>
