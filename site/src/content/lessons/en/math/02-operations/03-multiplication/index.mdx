...
multiplication method is built on. When you meet a larger multiplication, ask yourself:
"what if I break this number into tens and ones and handle each part?" — that question
will carry you through long multiplication and beyond.
</Inset>
...
products. Now when you see `13 × 4` — or any two-digit multiplication — your first
instinct will be to split by place and handle one part at a time.
</Recap>
