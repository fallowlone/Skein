...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "Four operations in depth"
...
<Hook>
This is a quiz-choice for the Four operations in depth unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Four operations in depth unit.
</Goal>
