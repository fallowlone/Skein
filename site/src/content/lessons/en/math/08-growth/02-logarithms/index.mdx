...
status: ready
summary: A logarithm runs an exponent backwards — it asks how many times you must
  multiply the base to reach a number, and so it measures explosive growth on a calm
  scale.
title: Logarithms
track: math
unit: 08-growth
