...
summary: "Multiple Choice Quiz for unit "Sharding PostgreSQL: shard keys, hot-shard failure mode, partitioning vs Citus""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Sharding PostgreSQL: shard keys, hot-shard failure mode, partitioning vs Citus unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Sharding PostgreSQL: shard keys, hot-shard failure mode, partitioning vs Citus unit.
</Goal>
