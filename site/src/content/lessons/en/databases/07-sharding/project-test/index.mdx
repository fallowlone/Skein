...
summary: "Project Testing for unit "Sharding PostgreSQL: shard keys, hot-shard failure mode, partitioning vs Citus""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Sharding PostgreSQL: shard keys, hot-shard failure mode, partitioning vs Citus unit.
</Hook>
