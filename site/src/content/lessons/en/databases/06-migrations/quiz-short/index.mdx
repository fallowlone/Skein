...
summary: "Short Answer Quiz for unit "Schema migrations in PostgreSQL: locks, expand-contract, and the lock-queue failure mode""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Schema migrations in PostgreSQL: locks, expand-contract, and the lock-queue failure mode unit.
</Hook>
