...
summary: "Project Testing for unit "Schema migrations in PostgreSQL: locks, expand-contract, and the lock-queue failure mode""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Schema migrations in PostgreSQL: locks, expand-contract, and the lock-queue failure mode unit.
</Hook>
