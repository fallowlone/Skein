...
summary: "Multiple Choice Quiz for unit "MVCC and isolation in PostgreSQL: snapshots, anomalies, bloat""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the MVCC and isolation in PostgreSQL: snapshots, anomalies, bloat unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the MVCC and isolation in PostgreSQL: snapshots, anomalies, bloat unit.
</Goal>
