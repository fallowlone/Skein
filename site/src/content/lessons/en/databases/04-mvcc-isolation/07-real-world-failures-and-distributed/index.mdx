...
summary: "Long transactions, orphan replication slots, pg_repack, pgbouncer SET LOCAL, idle_in_transaction_session_timeout, Postgres version history 8.3–18, and how distributed systems extend or replace single-node MVCC."
estMin: 20
status: ready
lessonType: topic
level: senior
prereqs: ["databases/04-mvcc-isolation/05-clog-xid-wraparound-and-multixact", "databases/04-mvcc-isolation/06-ssi-and-production-tuning"]
deepensInto: []
spiral: ["statefulness"]
concepts: ["long-transaction-bloat", "replication-slot", "pg-repack", "pgbouncer", "idle-in-transaction-session-timeout", "hot-standby-feedback", "hlc", "distributed-snapshot", "logical-replication", "bdr", "citus"]
sources:
