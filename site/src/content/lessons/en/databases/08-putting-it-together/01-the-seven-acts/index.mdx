...
- latency
status: ready
summary: A single product grows from a 1-table MVP to a 1-billion-row Citus cluster
  through seven moments of database failure — each one names the trigger, the symptom,
  and the lever that resolves it.
...
In ten minutes you will know which lever to pull at each growth stage — and why pulling the wrong one, or skipping one entirely, compounds into a failure at the next.
...
<Infographic
  svg={fixCostCurve}
  label="Column chart of the time to fix the same mistake, rising act by act: about a day at Act 1 (schema), through a week at Act 3 (stats) and a month at Act 5 (pool), to roughly a quarter — months — at Act 7 (sharding)."
  caption="Same mistake, paid for later: the cost of a late fix climbs exponentially across the seven acts — days at Act 1, months at Act 7."
  hue="var(--d-infra)"
/>
...
<StackDiagram
  label="The seven acts of database growth in order, from Day 0 schema design at the top down to Year 3 sharding at the bottom; each act unlocks the next."
  hue="var(--d-data)"
  layers={[
    { label: "Act 1 — Schema design", note: "Day 0" },
    { label: "Act 2 — Index the query", note: "Week 1, 10K rows" },
    { label: "Act 3 — ANALYZE statistics", note: "Month 1, 100K rows" },
    { label: "Act 4 — Kill bloat", note: "Month 6, 200 MB → 80 GB" },
    { label: "Act 5 — Connection pool", note: "Year 1, 50 pods" },
    { label: "Act 6 — Safe migration", note: "Year 2, multi-tenancy" },
    { label: "Act 7 — Shard", note: "Year 3, 1B rows" },
  ]}
  caption="Top = earliest, bottom = latest. The order is a constraint imposed by Postgres internals — each act unlocks the next only if you nailed the previous one."
/>
