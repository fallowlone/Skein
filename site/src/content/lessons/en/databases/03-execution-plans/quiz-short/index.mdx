...
summary: "Short Answer Quiz for unit "Execution plans: how PostgreSQL finds and executes your query""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Execution plans: how PostgreSQL finds and executes your query unit.
</Hook>
