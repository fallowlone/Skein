...
summary: "Project Testing for unit "Execution plans: how PostgreSQL finds and executes your query""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Execution plans: how PostgreSQL finds and executes your query unit.
</Hook>
