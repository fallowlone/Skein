...
summary: "Multiple Choice Quiz for unit "Execution plans: how PostgreSQL finds and executes your query""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Execution plans: how PostgreSQL finds and executes your query unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Execution plans: how PostgreSQL finds and executes your query unit.
</Goal>
