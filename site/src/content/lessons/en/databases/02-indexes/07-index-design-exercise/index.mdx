...
summary: "A synthesis exercise: choose the right index strategy for a full-text search feature, evaluate tradeoffs between GIN tsvector, pg_trgm, Elasticsearch, and pgvector HNSW, and design indexes for a complete ticketing system."
estMin: 20
status: ready
lessonType: topic
level: senior
