...
summary: "Beyond B-tree: when GIN, GiST, BRIN, Hash, and Bloom are the right tool, how HOT updates reduce index write overhead, why fillfactor matters, and why fresh statistics matter more than the index itself."
estMin: 18
status: ready
lessonType: topic
level: middle
prereqs: ["03-partial-expression-covering"]
deepensInto: []
spiral: ["latency"]
concepts: ["gin-index", "gist-index", "brin-index", "hash-index", "bloom-index", "hot-update", "fillfactor", "analyze-statistics", "write-amplification"]
sources:
