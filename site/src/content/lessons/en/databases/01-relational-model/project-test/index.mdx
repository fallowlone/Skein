...
summary: "Project Testing for unit "Relational model: tables, keys, constraints, when to bend the rules""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Relational model: tables, keys, constraints, when to bend the rules unit.
</Hook>
