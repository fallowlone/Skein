...
summary: "Multiple Choice Quiz for unit "Relational model: tables, keys, constraints, when to bend the rules""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Relational model: tables, keys, constraints, when to bend the rules unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Relational model: tables, keys, constraints, when to bend the rules unit.
</Goal>
