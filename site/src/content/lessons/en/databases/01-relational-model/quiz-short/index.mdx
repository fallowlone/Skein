...
summary: "Short Answer Quiz for unit "Relational model: tables, keys, constraints, when to bend the rules""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Relational model: tables, keys, constraints, when to bend the rules unit.
</Hook>
