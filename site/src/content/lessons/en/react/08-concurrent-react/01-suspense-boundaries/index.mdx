...
import fallbackCls from "./infographics/fallback-cls.svg?raw";
...
<Infographic
  svg={fallbackCls}
  label="Column chart of Cumulative Layout Shift by fallback strategy: a centered spinner scores 0.2, the Core Web Vitals budget line sits at 0.1, and a dimension-matched skeleton scores about 0.01."
  caption="A centered spinner blows past the 0.1 CWV budget at 0.2; a skeleton sized to the settled content lands an order of magnitude under it. The fallback's footprint is the whole CLS story."
  hue="var(--d-infra)"
/>
