...
<Crux>A provider re-renders every consumer when its value changes by Object.is — memo between them does not block it. Inline value objects broadcast on every provider render; split or memoize.</Crux>
