...
<Crux>useMemo caches a value, useCallback a function, React.memo skips on shallow-equal props. All three trade deps-comparison cost for referential stability — broken by one inline object.</Crux>
