...
<Crux>React matches elements to fibers by type + key; state lives on the fiber. Index keys make position the identity — reorder, and state stays put.</Crux>
