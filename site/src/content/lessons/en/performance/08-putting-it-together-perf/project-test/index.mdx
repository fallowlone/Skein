...
summary: "Project Testing for unit "Putting it together: performance as a discipline, not a project""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Putting it together: performance as a discipline, not a project unit.
</Hook>
