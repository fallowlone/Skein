...
order: 101
title: "Coding Quiz"
summary: "Coding Quiz for unit "Putting it together: performance as a discipline, not a project""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the Putting it together: performance as a discipline, not a project unit.
</Hook>
