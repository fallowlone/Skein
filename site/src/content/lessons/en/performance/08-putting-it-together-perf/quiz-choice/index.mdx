...
summary: "Multiple Choice Quiz for unit "Putting it together: performance as a discipline, not a project""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Putting it together: performance as a discipline, not a project unit.
</Hook>
