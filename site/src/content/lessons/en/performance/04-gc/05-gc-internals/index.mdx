...
summary: "Tri-color marking is the formal core of every concurrent GC. Write barriers maintain the invariant. Go's pacer, ZGC's colored pointers, and V8 Orinoco each implement the same ideas differently — knowing the implementation shapes how you write allocation-safe hot paths."
estMin: 18
status: ready
lessonType: topic
level: senior
