...
summary: "Project Building for unit "Garbage collection: pause budgets, allocation pressure, and the tail you don't see""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-build for the Garbage collection: pause budgets, allocation pressure, and the tail you don't see unit.
</Hook>
