...
- https://example.com
status: stub
summary: 'Project Building for unit "N+1: one logical operation, many round-trips"'
title: Project
track: performance
unit: 05-n-plus-one
---
...
<Hook>
This is a project-build for the N+1: one logical operation, many round-trips unit.
</Hook>
