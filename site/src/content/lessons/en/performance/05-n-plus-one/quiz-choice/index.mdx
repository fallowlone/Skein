...
- https://example.com
status: ready
summary: 'Multiple Choice Quiz for unit "N+1: one logical operation, many round-trips"'
...
<Hook>
This is a quiz-choice for the N+1: one logical operation, many round-trips unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the N+1: one logical operation, many round-trips unit.
</Goal>
