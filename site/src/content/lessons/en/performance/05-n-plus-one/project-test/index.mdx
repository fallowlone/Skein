...
summary: "Project Testing for unit "N+1: one logical operation, many round-trips""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the N+1: one logical operation, many round-trips unit.
</Hook>
