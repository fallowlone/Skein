...
summary: "How N+1 cascades into connection pool exhaustion, why fix strategies change query plans in surprising ways, how N+1 paths become DoS vectors, and when denormalisation is the right answer."
estMin: 16
status: ready
lessonType: topic
level: senior
