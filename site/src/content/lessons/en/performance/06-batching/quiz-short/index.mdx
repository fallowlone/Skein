...
- https://example.com
status: stub
summary: 'Short Answer Quiz for unit "Batching: amortize fixed cost per operation"'
...
<Hook>
This is a quiz-short for the Batching: amortize fixed cost per operation unit.
</Hook>
