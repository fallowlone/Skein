...
- https://example.com
status: stub
summary: 'Multiple Choice Quiz for unit "Batching: amortize fixed cost per operation"'
...
<Hook>
This is a quiz-choice for the Batching: amortize fixed cost per operation unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Batching: amortize fixed cost per operation unit.
</Goal>
