...
summary: "Multiple Choice Quiz for unit "Bundle budgets: the bytes your users actually pay for""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Bundle budgets: the bytes your users actually pay for unit.
</Hook>
