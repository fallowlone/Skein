...
summary: "Project Testing for unit "Bundle budgets: the bytes your users actually pay for""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Bundle budgets: the bytes your users actually pay for unit.
</Hook>
