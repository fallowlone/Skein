...
- https://example.com
status: ready
summary: Short Answer Quiz for unit "GraphQL N+1 and the cost of nested resolvers"
...
<Hook>
This is a quiz-short for the GraphQL N+1 and the cost of nested resolvers unit.
</Hook>
