...
summary: "DataLoader's exact scheduling semantics, tenant-safe per-request scoping, APQ vs trusted documents, multiplicative complexity scoring, alias-bomb anatomy, and the minimum-viable observability dashboard."
estMin: 18
status: ready
lessonType: topic
level: senior
...
concepts: ["enqueue-post-promise-job", "tenant-isolation", "apq-vs-trusted-documents", "multiplicative-complexity", "alias-bomb-anatomy", "resolver-observability"]
sources:
