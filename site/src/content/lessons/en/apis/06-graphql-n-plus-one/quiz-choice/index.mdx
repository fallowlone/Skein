...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "GraphQL N+1 and the cost of nested resolvers"
...
<Hook>
This is a quiz-choice for the GraphQL N+1 and the cost of nested resolvers unit.
</Hook>
