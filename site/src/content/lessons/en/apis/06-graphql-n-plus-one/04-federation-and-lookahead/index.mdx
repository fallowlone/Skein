...
summary: "Apollo Federation gives you cross-subgraph batching for free via _entities; you still owe the intra-subgraph DataLoader. Lookahead joins collapse multi-level nesting at the cost of resolver isolation."
estMin: 11
status: ready
lessonType: topic
level: middle
