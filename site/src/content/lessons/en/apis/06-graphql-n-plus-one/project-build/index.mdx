...
- https://example.com
status: ready
summary: Project Building for unit "GraphQL N+1 and the cost of nested resolvers"
...
<Hook>
This is a project-build for the GraphQL N+1 and the cost of nested resolvers unit.
</Hook>
