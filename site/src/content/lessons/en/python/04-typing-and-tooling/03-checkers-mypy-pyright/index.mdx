...
<FlowDiagram
  label="A value's journey through the proof: a union narrows guard by guard, Any dissolves the analysis, and CI turns the result into a merge gate"
  hue="var(--d-systems)"
  perRow={3}
  nodes={[
    { id: "union", label: "str | bytes | None", sub: "declared union" },
    { id: "guard", label: "is None / isinstance", sub: "narrowing guards" },
    { id: "narrowed", label: "str", sub: "proven type" },
    { id: "any", label: "Any", sub: "contagion: unchecked" },
    { id: "reveal", label: "reveal_type()", sub: "what checker believes" },
    { id: "ci", label: "CI gate", sub: "fail on new errors" },
  ]}
  edges={[
    { from: "union", to: "guard", label: "branch" },
    { from: "guard", to: "narrowed", label: "eliminate members" },
    { from: "any", to: "union", label: "dissolves proof" },
    { from: "reveal", to: "guard", label: "debug narrowing" },
    { from: "narrowed", to: "ci", label: "enforced on PR" },
  ]}
  caption="Strict flags quarantine Any (disallow-untyped-defs, warn-return-any); reveal_type shows where narrowing stopped working; CI is what turns hints from promises into proofs."
/>
