...
Since Python 3.8, `CancelledError` inherits from `BaseException`, not `Exception` — a deliberate breaking change made so that the most common defensive pattern stays safe:
