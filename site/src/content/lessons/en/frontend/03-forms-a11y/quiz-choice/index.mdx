...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "Forms a11y"
...
<Hook>
This is a quiz-choice for the Forms a11y unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Forms a11y unit.
</Goal>
