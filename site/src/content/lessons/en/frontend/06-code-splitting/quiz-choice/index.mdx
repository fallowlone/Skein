...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "Code splitting"
...
<Hook>
This is a quiz-choice for the Code splitting unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Code splitting unit.
</Goal>
