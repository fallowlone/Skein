...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "State shape"
...
<Hook>
This is a quiz-choice for the State shape unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the State shape unit.
</Goal>
