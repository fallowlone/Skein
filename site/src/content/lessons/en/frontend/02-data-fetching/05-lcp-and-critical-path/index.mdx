...
summary: "How to diagnose LCP regressions from the network waterfall, what prefetching patterns buy and cost, and how to eliminate race conditions in search-as-you-type fetching."
estMin: 10
status: ready
lessonType: topic
level: middle
