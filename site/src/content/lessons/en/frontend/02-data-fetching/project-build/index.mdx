...
summary: "Project Building for unit "Data fetching: server vs client, waterfalls, RSC, and SWR cache""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-build for the Data fetching: server vs client, waterfalls, RSC, and SWR cache unit.
</Hook>
