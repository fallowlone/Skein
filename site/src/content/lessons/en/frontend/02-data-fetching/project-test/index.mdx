...
summary: "Project Testing for unit "Data fetching: server vs client, waterfalls, RSC, and SWR cache""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Data fetching: server vs client, waterfalls, RSC, and SWR cache unit.
</Hook>
