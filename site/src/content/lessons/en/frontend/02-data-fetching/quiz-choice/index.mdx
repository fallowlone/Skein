...
summary: "Multiple Choice Quiz for unit "Data fetching: server vs client, waterfalls, RSC, and SWR cache""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Data fetching: server vs client, waterfalls, RSC, and SWR cache unit.
</Hook>
