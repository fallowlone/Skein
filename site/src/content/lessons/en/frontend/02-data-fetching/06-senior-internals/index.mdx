...
summary: "The RSC Payload wire format, Server Functions as type-safe API endpoints, multi-layer cache invalidation, hydration mismatches, and real production failures from Vercel, Spotify, and Linear."
estMin: 14
status: ready
lessonType: topic
level: senior
