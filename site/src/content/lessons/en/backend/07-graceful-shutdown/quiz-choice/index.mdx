...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "Graceful shutdown and drain"
...
<Hook>
This is a quiz-choice for the Graceful shutdown and drain unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Graceful shutdown and drain unit.
</Goal>
