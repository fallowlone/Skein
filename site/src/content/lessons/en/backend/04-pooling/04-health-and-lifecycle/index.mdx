...
summary: "A pooled connection is reused for hours, which is the whole point — but the database, firewalls, and load balancers all reserve the right to kill it underneath you. Without max-lifetime, idle eviction, and validation, the pool happily hands out dead connections."
estMin: 15
status: ready
lessonType: topic
level: middle
...
concepts: ["connection-lifecycle", "max-lifetime", "idle-timeout", "keepalive", "connection-validation", "stale-connection", "minimum-idle"]
sources:
