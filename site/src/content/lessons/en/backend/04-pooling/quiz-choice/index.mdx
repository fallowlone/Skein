...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "Connection and thread pooling"
...
<Hook>
This is a quiz-choice for the Connection and thread pooling unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Connection and thread pooling unit.
</Goal>
