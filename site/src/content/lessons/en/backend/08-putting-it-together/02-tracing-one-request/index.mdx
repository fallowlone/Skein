...
summary: "Follow one request and the seven units line up as layers: lifecycle accepts and parses, middleware and DI wire dependencies, async I/O and a pool carry the downstream call, a breaker guards it, an idempotency key makes the write retry-safe, and shutdown waits for it."
estMin: 16
status: ready
lessonType: topic
level: middle
