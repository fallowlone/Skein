...
<Infographic
  svg={overloadCurve}
  label="Line chart of the overload curve: goodput rises with offered load to a peak of 100 at 1× capacity C, then falls off a cliff — 55 at 1.5×C, 25 at 2×C, and 0 at 3×C — because accepting more load past saturation produces less useful work."
  caption="Below capacity, goodput tracks accepted load; the saturation point at 1×C is the peak. Past it, accepting more lowers goodput — the discipline of overload is staying at the top, not sliding down the cliff."
  hue="var(--d-infra)"
/>
