...
summary: "Multiple Choice Quiz for unit "Putting it together: production backend""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Putting it together: production backend unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Putting it together: production backend unit.
</Goal>
