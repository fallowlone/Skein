...
summary: "Project Planning for unit "Idempotency and retries: turning at-least-once into effectively-once""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the Idempotency and retries: turning at-least-once into effectively-once unit.
</Hook>
