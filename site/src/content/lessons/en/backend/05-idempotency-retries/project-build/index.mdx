...
summary: "Project Building for unit "Idempotency and retries: turning at-least-once into effectively-once""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-build for the Idempotency and retries: turning at-least-once into effectively-once unit.
</Hook>
