...
order: 101
title: "Coding Quiz"
summary: "Coding Quiz for unit "Idempotency and retries: turning at-least-once into effectively-once""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the Idempotency and retries: turning at-least-once into effectively-once unit.
</Hook>
