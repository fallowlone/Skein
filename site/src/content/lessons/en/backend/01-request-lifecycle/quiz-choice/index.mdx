...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "Request lifecycle"
...
<Hook>
This is a quiz-choice for the Request lifecycle unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Request lifecycle unit.
</Goal>
