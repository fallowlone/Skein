...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "Middleware and dependency injection"
...
<Hook>
This is a quiz-choice for the Middleware and dependency injection unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the Middleware and dependency injection unit.
</Goal>
