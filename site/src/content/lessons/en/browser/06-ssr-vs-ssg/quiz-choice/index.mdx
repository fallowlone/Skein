...
summary: "Multiple Choice Quiz for unit "Render strategies: SSR, SSG, ISR, streaming, RSC — and the cost of hydration""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Render strategies: SSR, SSG, ISR, streaming, RSC — and the cost of hydration unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Render strategies: SSR, SSG, ISR, streaming, RSC — and the cost of hydration unit.
</Goal>
