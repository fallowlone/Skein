...
order: 101
title: "Coding Quiz"
summary: "Coding Quiz for unit "Render strategies: SSR, SSG, ISR, streaming, RSC — and the cost of hydration""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the Render strategies: SSR, SSG, ISR, streaming, RSC — and the cost of hydration unit.
</Hook>
