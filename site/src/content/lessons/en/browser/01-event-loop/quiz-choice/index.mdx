...
summary: "Multiple Choice Quiz for unit "The event loop""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the The event loop unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the The event loop unit.
</Goal>
