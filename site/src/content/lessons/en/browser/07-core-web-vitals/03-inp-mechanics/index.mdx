...
summary: "Interaction to Next Paint decomposes into three parts — and early-only poor INP points straight at the hydration long task, not the event handlers."
estMin: 14
status: ready
lessonType: topic
level: middle
prereqs: ["01-what-vitals-measure", "browser/01-event-loop/01-loop-model", "browser/06-ssr-vs-ssg/03-hydration-cost"]
deepensInto: ["06-tradeoffs-and-observability"]
spiral: ["latency"]
concepts: ["INP", "input-delay", "processing-time", "presentation-delay", "long-task", "hydration-INP", "scheduler.yield", "startTransition", "LoAF"]
sources:
