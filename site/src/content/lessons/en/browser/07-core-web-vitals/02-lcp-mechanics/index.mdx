...
summary: "Largest Contentful Paint decomposes into TTFB, resource load delay, resource load time, and render delay — diagnosing and fixing the right phase is the whole game."
estMin: 14
status: ready
lessonType: topic
level: middle
...
spiral: ["latency"]
concepts: ["LCP", "preload-scanner", "fetchpriority", "TTFB", "resource-load-delay", "resource-load-time", "render-delay", "lazy-loading"]
sources:
