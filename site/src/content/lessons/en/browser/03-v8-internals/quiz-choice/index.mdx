...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "V8 internals"
...
<Hook>
This is a quiz-choice for the V8 internals unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the V8 internals unit.
</Goal>
