...
summary: "What the six pipeline stages are, who owns the kitchen, and why the 16.67 ms frame budget decides everything."
estMin: 10
status: ready
lessonType: topic
level: junior
prereqs: []
deepensInto: ["02-stages-and-threads"]
spiral: ["statefulness"]
concepts: ["render-pipeline", "parse-html", "cssom", "style", "layout", "paint", "composite", "frame-budget", "main-thread", "compositor-thread"]
sources:
