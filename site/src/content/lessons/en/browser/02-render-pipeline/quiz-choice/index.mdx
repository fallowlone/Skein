...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "The render pipeline"
...
<Hook>
This is a quiz-choice for the The render pipeline unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the The render pipeline unit.
</Goal>
