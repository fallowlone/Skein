...
summary: "LoAF and INP in production telemetry, off-main-thread scroll, display locking, reduced-motion, Web Workers, Service Workers, CI testing, and the complete render-pipeline attack surface."
estMin: 18
status: ready
lessonType: topic
level: senior
prereqs: ["07-beginmainframe-and-gpu"]
deepensInto: []
spiral: ["statefulness", "encapsulation"]
concepts: ["LoAF", "INP", "core-web-vitals", "passive-scroll", "display-locking", "reduced-motion", "web-workers", "service-worker", "lighthouse-ci", "RUM", "attack-surface"]
sources:
