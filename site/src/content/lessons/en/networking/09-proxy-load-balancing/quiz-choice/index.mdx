...
summary: "Multiple Choice Quiz for unit "Proxy and load balancing""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Proxy and load balancing unit.
</Hook>

<Goal lang="en>
After this lesson you will be able to apply the concepts from the Proxy and load balancing unit.
</Goal>
