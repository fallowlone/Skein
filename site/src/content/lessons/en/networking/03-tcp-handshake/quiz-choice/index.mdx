...
- https://example.com
status: stub
summary: Multiple Choice Quiz for unit "The TCP handshake"
...
<Hook>
This is a quiz-choice for the The TCP handshake unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the The TCP handshake unit.
</Goal>
