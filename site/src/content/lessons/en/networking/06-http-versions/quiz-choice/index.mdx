...
- https://example.com
status: stub
summary: 'Multiple Choice Quiz for unit "HTTP versions: from 1.1 to 3"'
...
<Hook>
This is a quiz-choice for the HTTP versions: from 1.1 to 3 unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the HTTP versions: from 1.1 to 3 unit.
</Goal>
