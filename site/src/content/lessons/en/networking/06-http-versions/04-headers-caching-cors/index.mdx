...
summary: "The HTTP header layer — methods, status codes, Cache-Control, ETags, cookies, CORS — is where most operational bugs live and most security wins or losses happen."
estMin: 16
status: ready
lessonType: topic
level: middle
...
spiral: []
concepts: ["http-methods", "idempotency", "status-codes", "cache-control", "etag", "conditional-request", "cors", "preflight", "cookies", "samesite", "httponly", "hsts", "csp", "content-negotiation", "range-requests"]
sources:
