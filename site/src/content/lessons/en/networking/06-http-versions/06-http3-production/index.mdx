...
summary: "Running HTTP/3 in production means understanding QUIC congestion control in userspace, ALPN-based version negotiation, silent fallback mechanics, and the metrics that reveal when UDP is being blocked."
estMin: 18
status: ready
lessonType: topic
level: senior
...
spiral: ["multiplexing"]
concepts: ["quic-congestion-control", "quic-stream-independence", "hpack-vs-qpack", "alpn-negotiation", "http3-fallback", "alt-svc", "https-svcb", "connection-coalescing", "0rtt-replay", "quic-userspace", "qlog", "alpn-distribution", "server-push-removal"]
sources:
