...
summary: "HTTP is not just request-response — chunked transfer, SSE, WebSockets, and gRPC each punch a hole in the single-response model for real-time and bidirectional communication."
estMin: 12
status: ready
lessonType: topic
level: middle
...
spiral: []
concepts: ["chunked-transfer", "sse", "server-sent-events", "websocket", "rfc-8441", "grpc", "grpc-web", "trailers", "brotli", "compression", "crime-breach", "rate-limiting", "token-bucket"]
sources:
