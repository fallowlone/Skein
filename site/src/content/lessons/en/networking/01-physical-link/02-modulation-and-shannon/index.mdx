...
summary: "PAM-5 on copper, photons through glass, OFDM over radio — every medium has its own encoding scheme. Shannon's theorem sets the absolute ceiling no engineering can exceed."
estMin: 12
status: ready
lessonType: topic
level: middle
prereqs: ["01-bits-on-the-wire"]
deepensInto: ["03-latency-math"]
spiral: ["bandwidth", "snr"]
concepts: ["modulation", "shannon-capacity", "pam5", "ofdm", "qam", "ethernet-framing", "bdp", "fec"]
sources:
