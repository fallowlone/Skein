...
order: 3
title: "Latency math"
summary: "Geography, medium, and hops each add measurable delay. Knowing the numbers lets you distinguish bugs from physics — and design around the floor you cannot lower."
estMin: 12
status: ready
lessonType: topic
level: middle
prereqs: ["02-modulation-and-shannon"]
deepensInto: ["04-bufferbloat-and-congestion"]
spiral: ["latency", "rtt"]
concepts: ["propagation-delay", "rtt", "latency-floor", "submarine-cables", "dwdm", "link-debugging"]
sources:
