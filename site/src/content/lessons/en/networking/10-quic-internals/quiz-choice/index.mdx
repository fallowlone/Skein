...
- https://example.com
status: ready
summary: Multiple Choice Quiz for unit "QUIC internals"
...
<Hook>
This is a quiz-choice for the QUIC internals unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the QUIC internals unit.
</Goal>
