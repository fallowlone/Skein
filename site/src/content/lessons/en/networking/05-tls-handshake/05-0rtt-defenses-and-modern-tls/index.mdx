...
summary: "Production 0-RTT replay defenses, STEK rotation at CDN scale, Encrypted ClientHello, hybrid post-quantum key exchange, kernel TLS offload, and the observability metrics every TLS-serving service should track."
estMin: 16
status: ready
lessonType: topic
level: senior
