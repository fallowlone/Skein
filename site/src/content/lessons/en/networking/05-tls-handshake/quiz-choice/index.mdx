...
summary: "Multiple Choice Quiz for unit "TLS 1.3: keys and confidentiality in one RTT""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the TLS 1.3: keys and confidentiality in one RTT unit.
</Hook>
