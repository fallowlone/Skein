...
summary: "NAT extended the IPv4 Internet past 4 billion addresses but broke end-to-end connectivity. IPv6, SLAAC, anycast, and dual-stack are the principled way forward."
estMin: 14
status: ready
lessonType: topic
level: middle
prereqs: ["04-mtu-and-fragmentation"]
deepensInto: ["06-ip-security-and-operations"]
spiral: []
concepts: ["nat", "cgnat", "rfc1918", "ipv6-slaac", "anycast", "dual-stack", "happy-eyeballs", "stun-turn-ice"]
sources:
