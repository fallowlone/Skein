...
summary: "Every field in the IPv4 and IPv6 headers has a job: TTL prevents loops, DSCP marks priority, the protocol field hands the payload to the right L4 handler."
estMin: 12
status: ready
lessonType: topic
level: middle
