...
summary: "IP is the addressed envelope every chunk of Internet traffic travels inside — no router knows the full route, yet millions cooperate to deliver the packet."
estMin: 10
status: ready
lessonType: topic
level: junior
prereqs: ["01-physical-link/01-bits-on-the-wire"]
deepensInto: ["02-reading-the-ip-header"]
spiral: ["encapsulation"]
concepts: ["ip-packet", "hop-by-hop-routing", "best-effort", "ipv4", "ipv6", "ttl"]
sources:
