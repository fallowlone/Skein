...
summary: "IP spoofing, BGP hijacks, DDoS amplification, and RPKI — the attacks at the network layer, how they work, and what operators do to defend against them."
estMin: 16
status: ready
lessonType: topic
level: senior
prereqs: ["05-nat-and-addressing"]
deepensInto: []
spiral: []
concepts: ["ip-spoofing", "bcp38", "urpf", "bgp-hijack", "rpki", "roa", "rov", "ddos-amplification", "data-plane"]
sources:
