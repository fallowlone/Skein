...
- https://example.com
status: ready
summary: 'Multiple Choice Quiz for unit "IP packets: addressed envelopes"'
...
<Hook>
This is a quiz-choice for the IP packets: addressed envelopes unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the IP packets: addressed envelopes unit.
</Goal>
