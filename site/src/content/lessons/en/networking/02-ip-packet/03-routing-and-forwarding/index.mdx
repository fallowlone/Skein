...
summary: "How routers decide where a packet goes next: longest-prefix match in the FIB, CIDR aggregation, BGP between autonomous systems, and ECMP across equal-cost paths."
estMin: 14
status: ready
lessonType: topic
level: middle
prereqs: ["02-reading-the-ip-header"]
deepensInto: ["04-mtu-and-fragmentation"]
spiral: []
concepts: ["longest-prefix-match", "fib", "routing-table", "cidr", "bgp", "as", "ecmp", "arp", "nd"]
sources:
