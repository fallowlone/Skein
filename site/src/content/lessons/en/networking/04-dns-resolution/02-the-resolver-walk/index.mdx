...
summary: "How a recursive resolver follows referrals from root to authoritative, what the DNS message sections mean, and why missing glue breaks everything."
estMin: 14
status: ready
lessonType: topic
level: middle
