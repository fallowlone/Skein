...
summary: "DNS turns human-friendly names into IP addresses through a hierarchy of servers — the phonebook the whole internet depends on."
estMin: 8
status: ready
lessonType: topic
level: junior
prereqs: ["03-tcp-handshake/06-bbr-and-production-ops"]
deepensInto: ["02-the-resolver-walk"]
spiral: ["statefulness"]
concepts: ["dns", "recursive-resolver", "root-server", "tld-server", "authoritative-nameserver", "a-record", "ttl", "dns-cache"]
sources:
