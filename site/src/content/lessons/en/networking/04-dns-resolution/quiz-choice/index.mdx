...
- https://example.com
status: stub
summary: 'Multiple Choice Quiz for unit "DNS: from name to address"'
...
<Hook>
This is a quiz-choice for the DNS: from name to address unit.
</Hook>

<Goal lang="en">
After this lesson you will be able to apply the concepts from the DNS: from name to address unit.
</Goal>
