...
summary: "How DNSSEC signs every RRset from root to leaf, what breaks when the DS-KSK link snaps, and why a KSK rollover without updating the parent DS silently takes your site offline for 30% of users."
estMin: 16
status: ready
lessonType: topic
level: senior
prereqs: ["03-ttl-and-caching"]
deepensInto: ["05-encrypted-dns"]
spiral: []
concepts: ["dnssec", "zsk", "ksk", "ds-record", "rrsig", "dnskey", "nsec", "nsec3", "bogus", "ad-bit", "trust-anchor", "ksk-rollover", "dnssec-validation", "chain-of-trust"]
sources:
