...
summary: "DataLoader ждёт окончания текущего тика event loop и делает один батчевый запрос за все накопленные ключи — превращая N per-item SQL-вызовов в один."
estMin: 13
status: ready
lessonType: topic
level: middle
