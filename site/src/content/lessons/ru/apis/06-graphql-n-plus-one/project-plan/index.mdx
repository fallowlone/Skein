...
- https://example.com
status: ready
summary: Планирование проекта for unit "GraphQL N+1 и цена вложенных резолверов"
...
<Hook>
This is a project-plan for the GraphQL N+1 и цена вложенных резолверов unit.
</Hook>
