...
- https://example.com
status: ready
summary: Тест с краткими ответами for unit "GraphQL N+1 и цена вложенных резолверов"
...
<Hook>
This is a quiz-short for the GraphQL N+1 и цена вложенных резолверов unit.
</Hook>
