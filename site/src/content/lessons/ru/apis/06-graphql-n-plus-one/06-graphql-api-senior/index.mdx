...
summary: "Точная семантика планирования DataLoader, tenant-safe per-request скоупинг, APQ vs trusted documents, мультипликативный complexity scoring, анатомия alias-бомбы и минимальный дашборд наблюдаемости."
estMin: 18
status: ready
lessonType: topic
level: senior
