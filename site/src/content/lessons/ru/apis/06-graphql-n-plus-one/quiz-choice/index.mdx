...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "GraphQL N+1 и цена вложенных резолверов"
...
<Hook>
This is a quiz-choice for the GraphQL N+1 и цена вложенных резолверов unit.
</Hook>
