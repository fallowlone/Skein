...
- https://example.com
status: ready
summary: Тестирование проекта for unit "GraphQL N+1 и цена вложенных резолверов"
...
<Hook>
This is a project-test for the GraphQL N+1 и цена вложенных резолверов unit.
</Hook>
