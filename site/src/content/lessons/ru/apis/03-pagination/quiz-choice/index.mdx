...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Pagination"
...
<Hook>
This is a quiz-choice for the Pagination unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Pagination unit.
</Goal>
