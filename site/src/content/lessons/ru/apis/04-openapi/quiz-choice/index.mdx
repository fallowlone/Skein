...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Openapi"
...
<Hook>
This is a quiz-choice for the Openapi unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Openapi unit.
</Goal>
