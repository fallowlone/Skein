...
summary: "Тест с множественным выбором for unit "Status codes real""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Status codes real unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Status codes real unit.
</Goal>
