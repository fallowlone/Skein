...
summary: "Тест с множественным выбором for unit "Rest modeling""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Rest modeling unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Rest modeling unit.
</Goal>
