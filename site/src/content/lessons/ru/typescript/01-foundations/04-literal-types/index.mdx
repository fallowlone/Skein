...
<Infographic
  svg={enumRuntimeCost}
  label="Столбчатая диаграмма отгружаемого рантайм-JavaScript на конструкцию: объединение литералов отгружает 0 байт, а числовой enum испускает примерно 150–400 байт кода объекта с обратным отображением."
  caption="Объединение литералов стирается в ничто; каждый числовой enum стоит ~150–400 байт — на ~30 enum статусов/ролей/методов это однозначные килобайты мёртвого веса, которые as const не платит."
  hue="var(--d-infra)"
/>
