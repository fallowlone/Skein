...
summary: "Тест с множественным выбором for unit "Форма состояния""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Форма состояния unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Форма состояния unit.
</Goal>
