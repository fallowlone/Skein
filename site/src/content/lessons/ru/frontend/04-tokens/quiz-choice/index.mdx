...
summary: "Тест с множественным выбором for unit "Дизайн-токены""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Дизайн-токены unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Дизайн-токены unit.
</Goal>
