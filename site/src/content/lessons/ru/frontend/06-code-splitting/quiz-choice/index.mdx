...
summary: "Тест с множественным выбором for unit "Разбивка кода""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Разбивка кода unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Разбивка кода unit.
</Goal>
