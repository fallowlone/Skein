...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Монорепозиторий"
...
<Hook>
This is a quiz-choice for the Монорепозиторий unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Монорепозиторий unit.
</Goal>
