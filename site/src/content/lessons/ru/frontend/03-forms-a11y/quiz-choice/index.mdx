...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Формы и доступность"
...
<Hook>
This is a quiz-choice for the Формы и доступность unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Формы и доступность unit.
</Goal>
