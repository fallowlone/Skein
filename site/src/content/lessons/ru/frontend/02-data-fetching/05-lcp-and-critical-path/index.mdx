...
summary: "Как диагностировать LCP регрессии по network waterfall, что даёт prefetch и чего стоит, и как устранить race conditions в поиске по мере ввода."
estMin: 10
status: ready
lessonType: topic
level: middle
...
spiral: ["statefulness"]
concepts: ["LCP", "Web-Vitals", "prefetch", "race-condition", "AbortController", "debounce", "pagination", "cursor-pagination"]
sources:
