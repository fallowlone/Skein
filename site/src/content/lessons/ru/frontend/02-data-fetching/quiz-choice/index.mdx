...
summary: "Тест с множественным выбором for unit "Data fetching: сервер vs клиент, waterfall'ы, RSC и SWR-кэш""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Data fetching: сервер vs клиент, waterfall'ы, RSC и SWR-кэш unit.
</Hook>
