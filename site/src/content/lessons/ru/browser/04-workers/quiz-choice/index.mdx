...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Воркеры"
...
<Hook>
This is a quiz-choice for the Воркеры unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Воркеры unit.
</Goal>
