...
summary: "Тест с множественным выбором for unit "Внутренности V8""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Внутренности V8 unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Внутренности V8 unit.
</Goal>
