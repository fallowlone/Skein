...
summary: "Три vital разделяют бюджет производительности — фикс одной может сломать другую. Полная production-observability требует web-vitals RUM для field-вердикта и throttled CI-гейта для регрессий — ни одного в отдельности недостаточно."
estMin: 16
status: ready
lessonType: topic
level: senior
