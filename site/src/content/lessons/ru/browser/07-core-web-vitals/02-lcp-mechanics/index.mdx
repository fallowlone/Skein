...
summary: "Largest Contentful Paint раскладывается на TTFB, задержку загрузки ресурса, время загрузки ресурса и задержку рендера — диагностировать и починить правильную фазу и есть вся игра."
estMin: 14
status: ready
lessonType: topic
level: middle
