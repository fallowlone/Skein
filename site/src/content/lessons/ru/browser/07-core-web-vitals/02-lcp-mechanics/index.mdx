...
<NumbersCard
  ...
  stats={[
    ...
    { label: "Resource load delay", value: "Зазор обнаружения в HTML/CSS/JS" },
    { label: "Resource load time", value: "Размер файла × скорость соединения" },
    { label: "Element render delay", value: "Render-blocking ресурсы" },
  ]}
  data-lesson-visual
/>
...
<FlowDiagram
  ...
  nodes={[
    ...
    { id: "delay", label: "Load delay", sub: "обнаружение" },
    { id: "load", label: "Load time", sub: "скачивание" },
    { id: "render", label: "Render delay", sub: "отрисовка" },
  ]}
  edges={[
    { from: "ttfb", to: "delay" },
    { from: "delay", to: "load" },
