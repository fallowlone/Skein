...
summary: "Тест с множественным выбором for unit "Event loop""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Event loop unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Event loop unit.
</Goal>
