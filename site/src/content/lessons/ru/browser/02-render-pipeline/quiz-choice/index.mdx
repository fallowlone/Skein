...
summary: "Тест с множественным выбором for unit "Пайплайн рендеринга""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Пайплайн рендеринга unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Пайплайн рендеринга unit.
</Goal>
