...
summary: "Тест с краткими ответами for unit "Стратегии рендеринга: SSR, SSG, ISR, streaming, RSC — и цена гидратации""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Стратегии рендеринга: SSR, SSG, ISR, streaming, RSC — и цена гидратации unit.
</Hook>
