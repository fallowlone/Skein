...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "React fiber-реконсилер"
...
<Hook>
This is a quiz-choice for the React fiber-реконсилер unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the React fiber-реконсилер unit.
</Goal>
