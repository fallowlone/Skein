...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Postmortems"
...
<Hook>
This is a quiz-choice for the Postmortems unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Postmortems unit.
</Goal>
