...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Trunk-based разработка"
...
<Hook>
This is a quiz-choice for the Trunk-based разработка unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Trunk-based разработка unit.
</Goal>
