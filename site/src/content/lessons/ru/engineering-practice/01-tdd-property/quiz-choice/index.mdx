...
summary: "Тест с множественным выбором for unit "TDD и property-based-тестирование""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the TDD и property-based-тестирование unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the TDD и property-based-тестирование unit.
</Goal>
