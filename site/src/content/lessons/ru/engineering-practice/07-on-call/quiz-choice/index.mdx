...
summary: "Тест с множественным выбором for unit "On call""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the On call unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the On call unit.
</Goal>
