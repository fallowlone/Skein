...
summary: "Тест с множественным выбором for unit "Жадные алгоритмы""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Жадные алгоритмы unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Жадные алгоритмы unit.
</Goal>
