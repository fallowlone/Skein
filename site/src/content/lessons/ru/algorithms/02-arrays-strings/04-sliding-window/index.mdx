...
<AlgoPoster
  ...
  label="Анимированная лента из шести ячеек со значениями 2, 3, 1, 2, 4, 3. Пунктирная рамка окна скользит вправо: растёт до четырёх ячеек с суммой 8, сжимается слева до суммы 6, снова растёт и встаёт на минимальное годное окно длины 3 с суммой 7."
  pattern="lane"
  data={{ title: "минимальный подмассив с суммой ≥ 7", cells: ["2", "3", "1", "2", "4", "3"], wins: [[0, 3], [1, 3], [1, 4], [2, 4]], sums: ["sum=8 ≥ 7 · len 4 · сжать!", "sum=6 < 7 · растим right", "sum=10 ≥ 7 · len 4 · сжать!", "sum=7 ≥ 7 · len 3 ✓ лучшее"], lo: "left", hi: "right", note: "каждый указатель только вперёд — всего 2n движений" }}
  steps={[
    ...
    { caption: "④ left сжимает к минимальному окну из 3…", state: "STATE: BEST len 3", log: "✓ shrink left→2 · sum=7 · len 3 best" }
  ]}
  minis={[
