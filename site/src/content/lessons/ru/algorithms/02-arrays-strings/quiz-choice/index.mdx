...
summary: "Тест с множественным выбором for unit "Массивы и строки""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Массивы и строки unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Массивы и строки unit.
</Goal>
