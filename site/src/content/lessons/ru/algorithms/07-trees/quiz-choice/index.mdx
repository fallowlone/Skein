...
summary: "Тест с множественным выбором for unit "Деревья""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Деревья unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Деревья unit.
</Goal>
