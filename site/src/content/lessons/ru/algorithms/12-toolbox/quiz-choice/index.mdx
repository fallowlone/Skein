...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Инструментарий решения задач"
...
<Hook>
This is a quiz-choice for the Инструментарий решения задач unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Инструментарий решения задач unit.
</Goal>
