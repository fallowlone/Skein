...
status: ready
summary: Алгоритм — это конечный список однозначных шагов, который превращает вход
  в выход.
...
<FlowDiagram
  label="Алгоритм: заданный вход проходит через конечную последовательность однозначных, детерминированных шагов и производит выход."
  perRow={5}
  hue="var(--d-systems)"
  nodes={[
    { id: "input", label: "Вход", sub: "[3, 9, 2, 7]" },
    { id: "step1", label: "Шаг 1", sub: "largest = первое" },
    { id: "step2", label: "Шаг 2", sub: "сравни каждое" },
    { id: "step3", label: "Шаг 3", sub: "оставь больше" },
    { id: "output", label: "Выход", sub: "9" },
  ]}
  edges={[
    { from: "input", to: "step1" },
    { from: "step1", to: "step2" },
    { from: "step2", to: "step3", label: "цикл" },
    { from: "step3", to: "output" },
  ]}
  caption="Заданный вход → конечный, упорядоченный список однозначных шагов → выход. Один и тот же вход всегда даёт один и тот же выход, и шаги всегда заканчиваются."
/>
