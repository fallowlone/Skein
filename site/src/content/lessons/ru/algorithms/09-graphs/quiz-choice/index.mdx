...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Графы"
...
<Hook>
This is a quiz-choice for the Графы unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Графы unit.
</Goal>
