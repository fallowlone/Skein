...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Связные списки, стеки, очереди"
...
<Hook>
This is a quiz-choice for the Связные списки, стеки, очереди unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Связные списки, стеки, очереди unit.
</Goal>
