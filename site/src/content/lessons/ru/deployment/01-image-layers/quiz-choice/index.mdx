...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Image layers"
...
<Hook>
This is a quiz-choice for the Image layers unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Image layers unit.
</Goal>
