...
summary: "Тест с множественным выбором for unit "Secrets at deploy""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Secrets at deploy unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Secrets at deploy unit.
</Goal>
