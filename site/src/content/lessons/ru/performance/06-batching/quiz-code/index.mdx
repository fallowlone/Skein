...
summary: "Кодировочный тест for unit "Batching: амортизируй фиксированную цену каждой операции""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the Batching: амортизируй фиксированную цену каждой операции unit.
</Hook>
