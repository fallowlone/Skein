...
summary: "Тест с краткими ответами for unit "Batching: амортизируй фиксированную цену каждой операции""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Batching: амортизируй фиксированную цену каждой операции unit.
</Hook>
