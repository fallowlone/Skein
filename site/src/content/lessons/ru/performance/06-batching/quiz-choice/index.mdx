...
summary: "Тест с множественным выбором for unit "Batching: амортизируй фиксированную цену каждой операции""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Batching: амортизируй фиксированную цену каждой операции unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Batching: амортизируй фиксированную цену каждой операции unit.
</Goal>
