...
- https://example.com
status: ready
summary: 'Сборка проекта for unit "N+1: одна логическая операция, много round-trip''''''''ов"'
...
<Hook>
This is a project-build for the N+1: одна логическая операция, много round-trip'ов unit.
</Hook>
