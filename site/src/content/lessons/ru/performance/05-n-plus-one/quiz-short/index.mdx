...
summary: "Тест с краткими ответами for unit "N+1: одна логическая операция, много round-trip'ов""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the N+1: одна логическая операция, много round-trip'ов unit.
</Hook>
