...
summary: "Тестирование проекта for unit "N+1: одна логическая операция, много round-trip'ов""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the N+1: одна логическая операция, много round-trip'ов unit.
</Hook>
