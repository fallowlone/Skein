...
- https://example.com
status: ready
summary: 'Кодировочный тест for unit "N+1: одна логическая операция, много round-trip''''''''ов"'
...
<Hook>
This is a quiz-code for the N+1: одна логическая операция, много round-trip'ов unit.
</Hook>
