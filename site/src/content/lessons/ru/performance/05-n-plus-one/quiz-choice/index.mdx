...
summary: "Тест с множественным выбором for unit "N+1: одна логическая операция, много round-trip'ов""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the N+1: одна логическая операция, много round-trip'ов unit.
</Hook>
