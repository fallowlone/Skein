...
summary: "Как N+1 каскадирует в исчерпание connection pool, почему стратегии фикса неожиданно меняют query plan'ы, как N+1 пути становятся DoS-векторами и когда денормализация — правильный ответ."
estMin: 16
status: ready
lessonType: topic
level: senior
...
deepensInto: []
spiral: ["latency"]
concepts: ["connection-pool-exhaustion", "query-plan-instability", "query-amplification-dos", "denormalisation", "cqrs-read-model", "prepared-statements"]
sources:
