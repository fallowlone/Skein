...
summary: "Тест с краткими ответами for unit "Сначала профиль: измерь куда реально уходит время""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Сначала профиль: измерь куда реально уходит время unit.
</Hook>
