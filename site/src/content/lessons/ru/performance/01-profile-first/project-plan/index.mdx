...
summary: "Планирование проекта for unit "Сначала профиль: измерь куда реально уходит время""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the Сначала профиль: измерь куда реально уходит время unit.
</Hook>
