...
- https://example.com
status: ready
summary: 'Сборка проекта for unit "Сначала профиль: измерь куда реально уходит время"'
...
<Hook>
This is a project-build for the Сначала профиль: измерь куда реально уходит время unit.
</Hook>
