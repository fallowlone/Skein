...
summary: "Кодировочный тест for unit "Сначала профиль: измерь куда реально уходит время""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the Сначала профиль: измерь куда реально уходит время unit.
</Hook>
