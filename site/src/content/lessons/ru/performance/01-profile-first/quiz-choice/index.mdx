...
summary: "Тест с множественным выбором for unit "Сначала профиль: измерь куда реально уходит время""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Сначала профиль: измерь куда реально уходит время unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Сначала профиль: измерь куда реально уходит время unit.
</Goal>
