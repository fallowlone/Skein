...
summary: "Тестирование проекта for unit "Сначала профиль: измерь куда реально уходит время""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Сначала профиль: измерь куда реально уходит время unit.
</Hook>
