...
summary: "Планирование проекта for unit "Складываем всё: performance как дисциплина, не как проект""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the Складываем всё: performance как дисциплина, не как проект unit.
</Hook>
