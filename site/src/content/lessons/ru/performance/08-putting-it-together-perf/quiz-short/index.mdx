...
summary: "Тест с краткими ответами for unit "Складываем всё: performance как дисциплина, не как проект""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Складываем всё: performance как дисциплина, не как проект unit.
</Hook>
