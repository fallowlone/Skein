...
summary: "Тестирование проекта for unit "Складываем всё: performance как дисциплина, не как проект""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Складываем всё: performance как дисциплина, не как проект unit.
</Hook>
