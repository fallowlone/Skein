...
summary: "Тест с множественным выбором for unit "Складываем всё: performance как дисциплина, не как проект""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Складываем всё: performance как дисциплина, не как проект unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Складываем всё: performance как дисциплина, не как проект unit.
</Goal>
