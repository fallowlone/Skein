...
summary: "Кодировочный тест for unit "Сборка мусора: бюджет пауз, давление аллокаций и невидимый хвост""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the Сборка мусора: бюджет пауз, давление аллокаций и невидимый хвост unit.
</Hook>
