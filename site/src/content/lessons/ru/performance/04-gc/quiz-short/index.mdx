...
summary: "Тест с краткими ответами for unit "Сборка мусора: бюджет пауз, давление аллокаций и невидимый хвост""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Сборка мусора: бюджет пауз, давление аллокаций и невидимый хвост unit.
</Hook>
