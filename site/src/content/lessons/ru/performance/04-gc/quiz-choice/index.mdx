...
summary: "Тест с множественным выбором for unit "Сборка мусора: бюджет пауз, давление аллокаций и невидимый хвост""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Сборка мусора: бюджет пауз, давление аллокаций и невидимый хвост unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Сборка мусора: бюджет пауз, давление аллокаций и невидимый хвост unit.
</Goal>
