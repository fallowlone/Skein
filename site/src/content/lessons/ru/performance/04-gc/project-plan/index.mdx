...
summary: "Планирование проекта for unit "Сборка мусора: бюджет пауз, давление аллокаций и невидимый хвост""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the Сборка мусора: бюджет пауз, давление аллокаций и невидимый хвост unit.
</Hook>
