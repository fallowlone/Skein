...
summary: "Тест с множественным выбором for unit "Горячие пути: диагностика, формы и исправления""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Горячие пути: диагностика, формы и исправления unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Горячие пути: диагностика, формы и исправления unit.
</Goal>
