...
- https://example.com
status: ready
summary: 'Кодировочный тест for unit "Горячие пути: диагностика, формы и исправления"'
...
<Hook>
This is a quiz-code for the Горячие пути: диагностика, формы и исправления unit.
</Hook>
