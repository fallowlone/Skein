...
- https://example.com
status: stub
summary: 'Тест с краткими ответами for unit "Горячие пути: диагностика, формы и исправления"'
...
<Hook>
This is a quiz-short for the Горячие пути: диагностика, формы и исправления unit.
</Hook>
