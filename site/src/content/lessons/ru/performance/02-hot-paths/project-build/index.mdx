...
summary: "Сборка проекта for unit "Горячие пути: диагностика, формы и исправления""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-build for the Горячие пути: диагностика, формы и исправления unit.
</Hook>
