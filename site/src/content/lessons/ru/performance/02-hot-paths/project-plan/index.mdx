...
- https://example.com
status: ready
summary: 'Планирование проекта for unit "Горячие пути: диагностика, формы и исправления"'
...
<Hook>
This is a project-plan for the Горячие пути: диагностика, формы и исправления unit.
</Hook>
