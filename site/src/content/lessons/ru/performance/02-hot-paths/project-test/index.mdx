...
- https://example.com
status: ready
summary: 'Тестирование проекта for unit "Горячие пути: диагностика, формы и исправления"'
...
<Hook>
This is a project-test for the Горячие пути: диагностика, формы и исправления unit.
</Hook>
