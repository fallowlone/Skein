...
summary: "Тест с множественным выбором for unit "Bundle budgets: байты, за которые юзеры реально платят""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Bundle budgets: байты, за которые юзеры реально платят unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Bundle budgets: байты, за которые юзеры реально платят unit.
</Goal>
