...
summary: "Четыре уровня компиляции V8, HTTP/3 Extensible Priorities (RFC 9218), 103 Early Hints и Subresource Integrity — senior-уровень bundle delivery: механизмы, объясняющие, почему меньший bundle всё равно варьируется в 2-3x в зависимости от способа доставки."
estMin: 18
status: ready
lessonType: topic
level: senior
