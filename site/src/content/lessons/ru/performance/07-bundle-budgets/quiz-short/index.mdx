...
summary: "Тест с краткими ответами for unit "Bundle budgets: байты, за которые юзеры реально платят""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Bundle budgets: байты, за которые юзеры реально платят unit.
</Hook>
