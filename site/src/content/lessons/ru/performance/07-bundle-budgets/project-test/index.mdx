...
summary: "Тестирование проекта for unit "Bundle budgets: байты, за которые юзеры реально платят""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Bundle budgets: байты, за которые юзеры реально платят unit.
</Hook>
