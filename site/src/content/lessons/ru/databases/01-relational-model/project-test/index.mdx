...
summary: "Тестирование проекта for unit "Реляционная модель: таблицы, ключи, constraints, когда гнуть правила""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Реляционная модель: таблицы, ключи, constraints, когда гнуть правила unit.
</Hook>
