...
summary: "Тест с множественным выбором for unit "Реляционная модель: таблицы, ключи, constraints, когда гнуть правила""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Реляционная модель: таблицы, ключи, constraints, когда гнуть правила unit.
</Hook>
