...
summary: "Планирование проекта for unit "Реляционная модель: таблицы, ключи, constraints, когда гнуть правила""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the Реляционная модель: таблицы, ключи, constraints, когда гнуть правила unit.
</Hook>
