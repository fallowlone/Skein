...
summary: "Тест с краткими ответами for unit "MVCC и изоляция в PostgreSQL: снимки, аномалии, bloat""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the MVCC и изоляция в PostgreSQL: снимки, аномалии, bloat unit.
</Hook>
