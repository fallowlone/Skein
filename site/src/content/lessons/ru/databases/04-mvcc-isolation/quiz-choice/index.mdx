...
summary: "Тест с множественным выбором for unit "MVCC и изоляция в PostgreSQL: снимки, аномалии, bloat""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the MVCC и изоляция в PostgreSQL: снимки, аномалии, bloat unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the MVCC и изоляция в PostgreSQL: снимки, аномалии, bloat unit.
</Goal>
