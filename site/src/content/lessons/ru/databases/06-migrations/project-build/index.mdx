...
summary: "Сборка проекта for unit "Миграции схемы в PostgreSQL: блокировки, expand-contract и режим отказа очереди блокировок""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-build for the Миграции схемы в PostgreSQL: блокировки, expand-contract и режим отказа очереди блокировок unit.
</Hook>
