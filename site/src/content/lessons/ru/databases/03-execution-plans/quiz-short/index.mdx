...
summary: "Тест с краткими ответами for unit "Планы выполнения: как PostgreSQL ищет и выполняет ваш запрос""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Планы выполнения: как PostgreSQL ищет и выполняет ваш запрос unit.
</Hook>
