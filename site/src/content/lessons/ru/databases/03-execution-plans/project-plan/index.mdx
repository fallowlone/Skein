...
summary: "Планирование проекта for unit "Планы выполнения: как PostgreSQL ищет и выполняет ваш запрос""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the Планы выполнения: как PostgreSQL ищет и выполняет ваш запрос unit.
</Hook>
