...
summary: "Тест с множественным выбором for unit "Планы выполнения: как PostgreSQL ищет и выполняет ваш запрос""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Планы выполнения: как PostgreSQL ищет и выполняет ваш запрос unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Планы выполнения: как PostgreSQL ищет и выполняет ваш запрос unit.
</Goal>
