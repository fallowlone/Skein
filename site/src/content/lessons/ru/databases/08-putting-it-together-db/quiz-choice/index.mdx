...
summary: "Тест с множественным выбором for unit "Всё вместе""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Всё вместе unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Всё вместе unit.
</Goal>
