...
summary: "За пределами B-tree: когда GIN, GiST, BRIN, Hash и Bloom — правильный инструмент, как HOT-обновления снижают write-overhead, почему fillfactor важен и почему свежая статистика важнее самого индекса."
estMin: 18
status: ready
lessonType: topic
level: middle
