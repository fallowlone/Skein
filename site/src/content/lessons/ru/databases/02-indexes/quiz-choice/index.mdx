...
summary: "Тест с множественным выбором for unit "Индексы в PostgreSQL: B-tree, GIN, GiST, BRIN и цена неправильного""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Индексы в PostgreSQL: B-tree, GIN, GiST, BRIN и цена неправильного unit.
</Hook>
