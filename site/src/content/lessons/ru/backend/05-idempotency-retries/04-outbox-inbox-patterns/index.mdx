...
summary: "Прямой dual-write в БД + Kafka ломается в любом порядке. Outbox пишет событие внутри транзакции БД; inbox дедуплицирует на стороне консумера. Вместе дают effectively-once доставку."
estMin: 16
status: ready
lessonType: topic
level: middle
