...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Graceful shutdown и дрейнирование"
...
<Hook>
This is a quiz-choice for the Graceful shutdown и дрейнирование unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Graceful shutdown и дрейнирование unit.
</Goal>
