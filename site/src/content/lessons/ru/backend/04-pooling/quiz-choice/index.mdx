...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Пулинг соединений и потоков"
...
<Hook>
This is a quiz-choice for the Пулинг соединений и потоков unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Пулинг соединений и потоков unit.
</Goal>
