...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Асинхронный vs блокирующий I/O"
...
<Hook>
This is a quiz-choice for the Асинхронный vs блокирующий I/O unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Асинхронный vs блокирующий I/O unit.
</Goal>
