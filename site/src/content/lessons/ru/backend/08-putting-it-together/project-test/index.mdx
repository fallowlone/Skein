...
- https://example.com
status: ready
summary: 'Тестирование проекта for unit "Собираем воедино: бэкенд для продакшена"'
...
<Hook>
This is a project-test for the Собираем воедино: бэкенд для продакшена unit.
</Hook>
