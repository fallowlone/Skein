...
- https://example.com
status: ready
summary: 'Тест с краткими ответами for unit "Собираем воедино: бэкенд для продакшена"'
...
<Hook>
This is a quiz-short for the Собираем воедино: бэкенд для продакшена unit.
</Hook>
