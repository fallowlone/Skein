...
- https://example.com
status: stub
summary: 'Тест с множественным выбором for unit "Собираем воедино: бэкенд для продакшена"'
...
<Hook>
This is a quiz-choice for the Собираем воедино: бэкенд для продакшена unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Собираем воедино: бэкенд для продакшена unit.
</Goal>
