...
- https://example.com
status: ready
summary: 'Планирование проекта for unit "Собираем воедино: бэкенд для продакшена"'
...
<Hook>
This is a project-plan for the Собираем воедино: бэкенд для продакшена unit.
</Hook>
