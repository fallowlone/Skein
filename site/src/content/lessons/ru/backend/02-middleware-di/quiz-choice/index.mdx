...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Middleware и внедрение зависимостей"
...
<Hook>
This is a quiz-choice for the Middleware и внедрение зависимостей unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Middleware и внедрение зависимостей unit.
</Goal>
