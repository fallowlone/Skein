...
summary: "Тест с множественным выбором for unit "Cap practice""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Cap practice unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Cap practice unit.
</Goal>
