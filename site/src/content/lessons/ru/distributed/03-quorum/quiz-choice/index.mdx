...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Quorum"
...
<Hook>
This is a quiz-choice for the Quorum unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Quorum unit.
</Goal>
