...
summary: "Тест с множественным выбором for unit "Leader election""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Leader election unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Leader election unit.
</Goal>
