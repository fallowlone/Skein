...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Retry amplification"
...
<Hook>
This is a quiz-choice for the Retry amplification unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Retry amplification unit.
</Goal>
