...
summary: "Joint consensus для безопасного membership change, паттерны Multi-Raft шардирования, leadership transfer для rolling deploy, минимально жизнеспособный Raft dashboard и три реальных production postmortem."
estMin: 16
status: ready
lessonType: topic
level: senior
...
concepts: ["joint-consensus", "multi-raft", "leadership-transfer", "raft-observability", "membership-change"]
sources:
