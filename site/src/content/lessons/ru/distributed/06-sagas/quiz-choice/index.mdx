...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Sagas"
...
<Hook>
This is a quiz-choice for the Sagas unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Sagas unit.
</Goal>
