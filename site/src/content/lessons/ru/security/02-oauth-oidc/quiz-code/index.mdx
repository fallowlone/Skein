...
summary: "Кодировочный тест for unit "OAuth 2.1 и OIDC: делегированная авторизация без утечек""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the OAuth 2.1 и OIDC: делегированная авторизация без утечек unit.
</Hook>
