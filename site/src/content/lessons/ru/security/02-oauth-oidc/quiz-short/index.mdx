...
summary: "Тест с краткими ответами for unit "OAuth 2.1 и OIDC: делегированная авторизация без утечек""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the OAuth 2.1 и OIDC: делегированная авторизация без утечек unit.
</Hook>
