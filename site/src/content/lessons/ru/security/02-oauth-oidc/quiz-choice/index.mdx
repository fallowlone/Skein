...
summary: "Тест с множественным выбором for unit "OAuth 2.1 и OIDC: делегированная авторизация без утечек""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the OAuth 2.1 и OIDC: делегированная авторизация без утечек unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the OAuth 2.1 и OIDC: делегированная авторизация без утечек unit.
</Goal>
