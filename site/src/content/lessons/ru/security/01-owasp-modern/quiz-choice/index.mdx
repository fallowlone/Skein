...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Owasp modern"
...
<Hook>
This is a quiz-choice for the Owasp modern unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Owasp modern unit.
</Goal>
