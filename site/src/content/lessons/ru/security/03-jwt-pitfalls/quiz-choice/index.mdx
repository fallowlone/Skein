...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Jwt pitfalls"
...
<Hook>
This is a quiz-choice for the Jwt pitfalls unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Jwt pitfalls unit.
</Goal>
