...
summary: "Тест с множественным выбором for unit "Secrets""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Secrets unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Secrets unit.
</Goal>
