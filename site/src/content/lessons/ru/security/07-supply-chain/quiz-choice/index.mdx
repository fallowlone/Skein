...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Supply chain"
...
<Hook>
This is a quiz-choice for the Supply chain unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Supply chain unit.
</Goal>
