...
Раздутые агрегаты из fan-out JOIN — это аналитический баг, который доезжает до прода: запрос отрабатывает, возвращает числа, и числа тихо завышены в 3 раза.
