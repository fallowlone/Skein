...
<Infographic
  svg={headerAttackMap}
  label="Список, сопоставляющий каждый из пяти заголовков безопасности с одной именованной атакой, которую он гасит: Content-Security-Policy режет XSS, Strict-Transport-Security режет SSL-strip и MITM, X-Content-Type-Options nosniff гасит MIME-угадывание, frame-ancestors / X-Frame-Options блокируют кликджекинг, а Referrer-Policy гасит утечку URL и токенов."
  caption="Каждый заголовок — самый дешёвый слой, которым ты владеешь, и связан с одной конкретной атакой: поставишь не тот — получишь ложное чувство защищённости, а не защиту."
  hue="var(--d-infra)"
/>
