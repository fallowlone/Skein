...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Streaming"
...
<Hook>
This is a quiz-choice for the Streaming unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Streaming unit.
</Goal>
