...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Tool calls"
...
<Hook>
This is a quiz-choice for the Tool calls unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Tool calls unit.
</Goal>
