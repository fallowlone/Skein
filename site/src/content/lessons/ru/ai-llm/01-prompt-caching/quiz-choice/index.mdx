...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Prompt caching"
...
<Hook>
This is a quiz-choice for the Prompt caching unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Prompt caching unit.
</Goal>
