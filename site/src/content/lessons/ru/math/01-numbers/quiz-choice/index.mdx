...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Числа и счёт"
...
<Hook>
This is a quiz-choice for the Числа и счёт unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Числа и счёт unit.
</Goal>
