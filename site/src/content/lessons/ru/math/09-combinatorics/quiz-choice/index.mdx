...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Комбинаторика"
...
<Hook>
This is a quiz-choice for the Комбинаторика unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Комбинаторика unit.
</Goal>
