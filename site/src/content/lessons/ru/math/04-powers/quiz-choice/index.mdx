...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Степени и корни"
...
<Hook>
This is a quiz-choice for the Степени и корни unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Степени и корни unit.
</Goal>
