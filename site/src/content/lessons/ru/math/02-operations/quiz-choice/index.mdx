...
summary: "Тест с множественным выбором for unit "Четыре действия глубоко""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Четыре действия глубоко unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Четыре действия глубоко unit.
</Goal>
