...
summary: "Тест с множественным выбором for unit "Логика и множества""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Логика и множества unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Логика и множества unit.
</Goal>
