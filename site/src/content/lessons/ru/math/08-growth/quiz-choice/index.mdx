...
summary: "Тест с множественным выбором for unit "Рост и логарифмы""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Рост и логарифмы unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Рост и логарифмы unit.
</Goal>
