...
summary: "Тест с множественным выбором for unit "Переменные и алгебра""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Переменные и алгебра unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Переменные и алгебра unit.
</Goal>
