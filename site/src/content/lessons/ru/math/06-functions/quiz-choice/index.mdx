...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Функции"
...
<Hook>
This is a quiz-choice for the Функции unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Функции unit.
</Goal>
