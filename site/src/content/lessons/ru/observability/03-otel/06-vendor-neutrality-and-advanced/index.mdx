...
unit: 03-otel
order: 6
title: "Vendor-нейтральность, eBPF-инструментирование, Operator и OTel в браузере и serverless"
summary: "Настоящая vendor-нейтральность живёт на edge приложения, а не в Collector. eBPF покрывает широту; SDK-инструментирование покрывает глубину. OTel Operator превращает инструментирование в ответственность платформенной команды. Браузер и serverless имеют ограничения OTLP/HTTP."
estMin: 14
status: ready
lessonType: topic
level: senior
