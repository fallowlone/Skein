...
summary: "Планирование проекта for unit "Profiling: куда реально ушли CPU и байты""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the Profiling: куда реально ушли CPU и байты unit.
</Hook>
