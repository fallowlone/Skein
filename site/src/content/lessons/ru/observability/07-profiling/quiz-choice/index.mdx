...
summary: "Тест с множественным выбором for unit "Profiling: куда реально ушли CPU и байты""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Profiling: куда реально ушли CPU и байты unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Profiling: куда реально ушли CPU и байты unit.
</Goal>
