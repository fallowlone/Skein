...
summary: "Тестирование проекта for unit "Profiling: куда реально ушли CPU и байты""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Profiling: куда реально ушли CPU и байты unit.
</Hook>
