...
- https://example.com
status: stub
summary: 'Тест с краткими ответами for unit "Profiling: куда реально ушли CPU и байты"'
...
<Hook>
This is a quiz-short for the Profiling: куда реально ушли CPU и байты unit.
</Hook>
