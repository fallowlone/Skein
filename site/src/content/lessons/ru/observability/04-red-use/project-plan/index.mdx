...
summary: "Планирование проекта for unit "RED и USE: две половины каждого дашборда""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the RED и USE: две половины каждого дашборда unit.
</Hook>
