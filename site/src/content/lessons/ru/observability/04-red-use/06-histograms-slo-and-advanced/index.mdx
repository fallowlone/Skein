...
summary: "Native (exponential) histograms устраняют ручную настройку бакетов. Duration и Errors из RED напрямую питают SLO error budget. Реальные production-сбои — Cloudflare, GitHub, Stripe, Discord — каждый сводится к конкретному пропущенному RED+USE сигналу."
estMin: 16
status: ready
lessonType: topic
level: middle
