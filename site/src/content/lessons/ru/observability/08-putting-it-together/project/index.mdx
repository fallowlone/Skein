...
- https://example.com
status: stub
summary: 'Сборка проекта for unit "Соединяем всё: production-observability-история"'
...
<Hook>
This is a project-build for the Соединяем всё: production-observability-история unit.
</Hook>
