...
- https://example.com
status: ready
summary: 'Кодировочный тест for unit "Соединяем всё: production-observability-история"'
...
<Hook>
This is a quiz-code for the Соединяем всё: production-observability-история unit.
</Hook>
