...
- https://example.com
status: stub
summary: 'Тест с краткими ответами for unit "Соединяем всё: production-observability-история"'
...
<Hook>
This is a quiz-short for the Соединяем всё: production-observability-история unit.
</Hook>
