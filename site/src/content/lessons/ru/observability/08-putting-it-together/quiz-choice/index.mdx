...
- https://example.com
status: stub
summary: 'Тест с множественным выбором for unit "Соединяем всё: production-observability-история"'
...
<Hook>
This is a quiz-choice for the Соединяем всё: production-observability-история unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Соединяем всё: production-observability-история unit.
</Goal>
