...
summary: "Тестирование проекта for unit "Trace propagation: заголовки, сшивающие сервисы воедино""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the Trace propagation: заголовки, сшивающие сервисы воедино unit.
</Hook>
