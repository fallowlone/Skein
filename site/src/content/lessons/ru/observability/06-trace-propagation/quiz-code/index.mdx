...
summary: "Кодировочный тест for unit "Trace propagation: заголовки, сшивающие сервисы воедино""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the Trace propagation: заголовки, сшивающие сервисы воедино unit.
</Hook>
