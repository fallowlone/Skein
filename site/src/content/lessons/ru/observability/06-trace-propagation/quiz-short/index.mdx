...
summary: "Тест с краткими ответами for unit "Trace propagation: заголовки, сшивающие сервисы воедино""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Trace propagation: заголовки, сшивающие сервисы воедино unit.
</Hook>
