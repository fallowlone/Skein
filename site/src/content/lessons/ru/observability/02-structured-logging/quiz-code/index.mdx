...
- https://example.com
status: stub
summary: 'Кодировочный тест for unit "Структурное логирование: схема, levels, редакция"'
...
<Hook>
This is a quiz-code for the Структурное логирование: схема, levels, редакция unit.
</Hook>
