...
summary: "Тест с краткими ответами for unit "Структурное логирование: схема, levels, редакция""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Структурное логирование: схема, levels, редакция unit.
</Hook>
