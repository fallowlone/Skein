...
- https://example.com
status: stub
summary: 'Сборка проекта for unit "Структурное логирование: схема, levels, редакция"'
...
<Hook>
This is a project-build for the Структурное логирование: схема, levels, редакция unit.
</Hook>
