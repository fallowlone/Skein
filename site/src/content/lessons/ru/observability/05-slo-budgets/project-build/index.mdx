...
summary: "Сборка проекта for unit "SLI, SLO и error budget: надёжность в числах""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-build for the SLI, SLO и error budget: надёжность в числах unit.
</Hook>
