...
- https://example.com
status: ready
summary: 'Кодировочный тест for unit "SLI, SLO и error budget: надёжность в числах"'
...
<Hook>
This is a quiz-code for the SLI, SLO и error budget: надёжность в числах unit.
</Hook>
