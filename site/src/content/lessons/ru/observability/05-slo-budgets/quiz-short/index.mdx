...
summary: "Тест с краткими ответами for unit "SLI, SLO и error budget: надёжность в числах""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the SLI, SLO и error budget: надёжность в числах unit.
</Hook>
