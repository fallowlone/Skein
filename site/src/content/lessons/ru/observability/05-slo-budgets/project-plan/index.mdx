...
- https://example.com
status: ready
summary: 'Планирование проекта for unit "SLI, SLO и error budget: надёжность в числах"'
...
<Hook>
This is a project-plan for the SLI, SLO и error budget: надёжность в числах unit.
</Hook>
