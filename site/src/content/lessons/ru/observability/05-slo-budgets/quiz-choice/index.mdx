...
summary: "Тест с множественным выбором for unit "SLI, SLO и error budget: надёжность в числах""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the SLI, SLO и error budget: надёжность в числах unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the SLI, SLO и error budget: надёжность в числах unit.
</Goal>
