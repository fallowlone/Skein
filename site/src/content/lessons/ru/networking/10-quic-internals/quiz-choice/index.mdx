...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Внутреннее устройство QUIC"
...
<Hook>
This is a quiz-choice for the Внутреннее устройство QUIC unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Внутреннее устройство QUIC unit.
</Goal>
