...
summary: "Кодировочный тест for unit "TLS 1.3: ключи и конфиденциальность за один RTT""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the TLS 1.3: ключи и конфиденциальность за один RTT unit.
</Hook>
