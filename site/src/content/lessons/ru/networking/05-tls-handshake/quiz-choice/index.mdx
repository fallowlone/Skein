...
summary: "Тест с множественным выбором for unit "TLS 1.3: ключи и конфиденциальность за один RTT""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the TLS 1.3: ключи и конфиденциальность за один RTT unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the TLS 1.3: ключи и конфиденциальность за один RTT unit.
</Goal>
