...
- https://example.com
status: ready
summary: 'Сборка проекта for unit "TLS 1.3: ключи и конфиденциальность за один RTT"'
...
<Hook>
This is a project-build for the TLS 1.3: ключи и конфиденциальность за один RTT unit.
</Hook>
