...
summary: "Планирование проекта for unit "TLS 1.3: ключи и конфиденциальность за один RTT""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the TLS 1.3: ключи и конфиденциальность за один RTT unit.
</Hook>
