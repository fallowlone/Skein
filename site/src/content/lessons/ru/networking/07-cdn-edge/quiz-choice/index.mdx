...
summary: "Тест с множественным выбором for unit "CDN и edge-доставка""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the CDN и edge-доставка unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the CDN и edge-доставка unit.
</Goal>
