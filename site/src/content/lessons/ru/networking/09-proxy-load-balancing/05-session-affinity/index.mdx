...
summary: "Sticky sessions вызывают дисбаланс нагрузки в 1,5–2,5 раза и потерю сессии при отказе; consistent hashing минимизирует переотображение при изменении состава; правильное решение — Redis."
estMin: 12
status: ready
lessonType: topic
level: middle
...
spiral: ["statefulness"]
concepts: ["session-affinity", "sticky-sessions", "cookie-based-affinity", "ip-hash-affinity", "consistent-hashing", "virtual-nodes", "rendezvous-hashing", "redis-session-store"]
sources:
