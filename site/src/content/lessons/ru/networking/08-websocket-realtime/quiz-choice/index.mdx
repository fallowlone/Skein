...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "WebSocket и реальное время"
...
<Hook>
This is a quiz-choice for the WebSocket и реальное время unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the WebSocket и реальное время unit.
</Goal>
