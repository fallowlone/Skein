...
summary: "Как настроить Nginx и ALB для долгоживущих upgrade, защититься от DoS и cache-poisoning, и масштабировать WebSocket-кластеры с pub/sub и sticky sessions."
estMin: 14
status: ready
lessonType: topic
level: senior
