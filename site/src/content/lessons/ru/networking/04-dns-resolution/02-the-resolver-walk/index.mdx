...
summary: "Как рекурсивный резолвер следует перенаправлениям от root до авторитативного, что содержат секции DNS-сообщения и почему отсутствие glue ломает всё."
estMin: 14
status: ready
lessonType: topic
level: middle
prereqs: ["01-dns-what-it-does"]
deepensInto: ["03-ttl-and-caching"]
spiral: ["statefulness"]
concepts: ["dns-referral", "authority-section", "additional-section", "glue-record", "a-record", "aaaa-record", "cname", "mx-record", "txt-record", "ns-record", "soa-record", "edns0", "axfr", "ixfr", "rd-bit", "tc-flag", "stub-resolver", "open-resolver"]
sources:
