...
summary: "Слой заголовков HTTP — методы, статус-коды, Cache-Control, ETag, куки, CORS — где живут большинство операционных багов и происходят победы или поражения в безопасности."
estMin: 16
status: ready
lessonType: topic
level: middle
