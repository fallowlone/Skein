...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "TCP-рукопожатие"
...
<Hook>
This is a quiz-choice for the TCP-рукопожатие unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the TCP-рукопожатие unit.
</Goal>
