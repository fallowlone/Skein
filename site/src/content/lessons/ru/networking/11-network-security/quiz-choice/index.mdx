...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Сетевая безопасность"
...
<Hook>
This is a quiz-choice for the Сетевая безопасность unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Сетевая безопасность unit.
</Goal>
