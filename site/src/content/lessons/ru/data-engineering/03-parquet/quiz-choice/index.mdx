...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Parquet"
...
<Hook>
This is a quiz-choice for the Parquet unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Parquet unit.
</Goal>
