...
summary: "Тест с множественным выбором for unit "Materialized views""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Materialized views unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Materialized views unit.
</Goal>
