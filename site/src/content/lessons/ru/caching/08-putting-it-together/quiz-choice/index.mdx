...
summary: "Тест с множественным выбором for unit "Проектирование системы кэширования: объединение всех уровней""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Проектирование системы кэширования: объединение всех уровней unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Проектирование системы кэширования: объединение всех уровней unit.
</Goal>
