...
summary: "Тест с краткими ответами for unit "Проектирование системы кэширования: объединение всех уровней""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Проектирование системы кэширования: объединение всех уровней unit.
</Hook>
