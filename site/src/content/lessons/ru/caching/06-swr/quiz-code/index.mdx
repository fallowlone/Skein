...
summary: "Кодировочный тест for unit "Stale-while-revalidate: отдать устаревшее, обновить в фоне""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-code for the Stale-while-revalidate: отдать устаревшее, обновить в фоне unit.
</Hook>
