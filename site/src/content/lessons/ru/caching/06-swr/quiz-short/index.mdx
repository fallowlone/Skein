...
summary: "Тест с краткими ответами for unit "Stale-while-revalidate: отдать устаревшее, обновить в фоне""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Stale-while-revalidate: отдать устаревшее, обновить в фоне unit.
</Hook>
