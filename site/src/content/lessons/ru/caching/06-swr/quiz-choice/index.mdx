...
summary: "Тест с множественным выбором for unit "Stale-while-revalidate: отдать устаревшее, обновить в фоне""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Stale-while-revalidate: отдать устаревшее, обновить в фоне unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Stale-while-revalidate: отдать устаревшее, обновить в фоне unit.
</Goal>
