...
summary: "Сборка проекта for unit "Stale-while-revalidate: отдать устаревшее, обновить в фоне""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-build for the Stale-while-revalidate: отдать устаревшее, обновить в фоне unit.
</Hook>
