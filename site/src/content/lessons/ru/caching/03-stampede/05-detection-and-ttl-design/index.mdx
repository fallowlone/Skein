...
summary: "Observability-отпечаток cache stampede, минимально-жизнеспособные dashboard-метрики, TTL jitter для размазывания границ, negative caching и стратегии pre-warming для выживания при cold-start перезапусках."
estMin: 13
status: ready
lessonType: topic
level: middle
...
concepts: ["ttl-jitter", "negative-caching", "cache-pre-warming", "stampede-observability", "periodic-spikes", "miss-rate-sawtooth"]
sources:
