...
summary: "Сборка проекта for unit "Cache stampede: когда одно TTL истечение превращается в тысячи SQL-запросов""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-build for the Cache stampede: когда одно TTL истечение превращается в тысячи SQL-запросов unit.
</Hook>
