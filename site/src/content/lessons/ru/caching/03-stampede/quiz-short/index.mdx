...
summary: "Тест с краткими ответами for unit "Cache stampede: когда одно TTL истечение превращается в тысячи SQL-запросов""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Cache stampede: когда одно TTL истечение превращается в тысячи SQL-запросов unit.
</Hook>
