...
summary: "Директива stale-while-revalidate из RFC 5861 немедленно возвращает устаревшее значение из кеша, обновляясь в фоне — полностью устраняя ожидание. CDN расширяет это с request coalescing, который форвардит ровно один origin-запрос на каждый cache miss."
estMin: 12
status: ready
lessonType: topic
level: middle
