...
summary: "Тест с краткими ответами for unit "Cache-Control: управление браузерами и CDN""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Cache-Control: управление браузерами и CDN unit.
</Hook>
