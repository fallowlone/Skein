...
- https://example.com
status: ready
summary: 'Сборка проекта for unit "Cache-Control: управление браузерами и CDN"'
...
<Hook>
This is a project-build for the Cache-Control: управление браузерами и CDN unit.
</Hook>
