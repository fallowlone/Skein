...
- https://example.com
status: ready
summary: 'Кодировочный тест for unit "Cache-Control: управление браузерами и CDN"'
...
<Hook>
This is a quiz-code for the Cache-Control: управление браузерами и CDN unit.
</Hook>
