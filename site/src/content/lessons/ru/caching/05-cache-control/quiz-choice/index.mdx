...
summary: "Тест с множественным выбором for unit "Cache-Control: управление браузерами и CDN""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Cache-Control: управление браузерами и CDN unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the Cache-Control: управление браузерами и CDN unit.
</Goal>
