...
summary: "Планирование проекта for unit "ETag: условные запросы и ответы без тела""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the ETag: условные запросы и ответы без тела unit.
</Hook>
