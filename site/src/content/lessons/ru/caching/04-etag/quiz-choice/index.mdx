...
summary: "Тест с множественным выбором for unit "ETag: условные запросы и ответы без тела""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the ETag: условные запросы и ответы без тела unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the ETag: условные запросы и ответы без тела unit.
</Goal>
