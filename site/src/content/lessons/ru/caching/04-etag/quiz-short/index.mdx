...
- https://example.com
status: stub
summary: 'Тест с краткими ответами for unit "ETag: условные запросы и ответы без тела"'
...
<Hook>
This is a quiz-short for the ETag: условные запросы и ответы без тела unit.
</Hook>
