...
summary: "Тестирование проекта for unit "ETag: условные запросы и ответы без тела""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-test for the ETag: условные запросы и ответы без тела unit.
</Hook>
