...
summary: "Тест с множественным выбором for unit "Инвалидация кэша: самая сложная задача в CS""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Инвалидация кэша: самая сложная задача в CS unit.
</Hook>
