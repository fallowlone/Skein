...
summary: "Планирование проекта for unit "Инвалидация кэша: самая сложная задача в CS""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the Инвалидация кэша: самая сложная задача в CS unit.
</Hook>
