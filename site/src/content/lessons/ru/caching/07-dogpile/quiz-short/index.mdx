...
summary: "Тест с краткими ответами for unit "Dogpile-эффект: одновременные промахи кэша, которые убивают origin""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Dogpile-эффект: одновременные промахи кэша, которые убивают origin unit.
</Hook>
