...
summary: "Планирование проекта for unit "Dogpile-эффект: одновременные промахи кэша, которые убивают origin""
estMin: 60
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a project-plan for the Dogpile-эффект: одновременные промахи кэша, которые убивают origin unit.
</Hook>
