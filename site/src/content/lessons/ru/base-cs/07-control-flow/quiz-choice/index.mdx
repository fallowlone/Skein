...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Поток управления"
...
<Hook>
This is a quiz-choice for the Поток управления unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Поток управления unit.
</Goal>
