...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Процессор"
...
<Hook>
This is a quiz-choice for the Процессор unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Процессор unit.
</Goal>
