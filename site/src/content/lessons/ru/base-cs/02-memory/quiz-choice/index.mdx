...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Память"
...
<Hook>
This is a quiz-choice for the Память unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Память unit.
</Goal>
