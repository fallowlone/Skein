...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Абстракция"
...
<Hook>
This is a quiz-choice for the Абстракция unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Абстракция unit.
</Goal>
