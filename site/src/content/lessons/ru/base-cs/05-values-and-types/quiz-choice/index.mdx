...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Значения и типы"
...
<Hook>
This is a quiz-choice for the Значения и типы unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Значения и типы unit.
</Goal>
