...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Переменные и состояние"
...
<Hook>
This is a quiz-choice for the Переменные и состояние unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Переменные и состояние unit.
</Goal>
