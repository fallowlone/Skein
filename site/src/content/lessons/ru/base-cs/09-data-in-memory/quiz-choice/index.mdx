...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Данные в памяти"
...
<Hook>
This is a quiz-choice for the Данные в памяти unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Данные в памяти unit.
</Goal>
