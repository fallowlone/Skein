...
summary: "Тест с краткими ответами for unit "Гарантии доставки: at-most-once, at-least-once и правда об exactly-once""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-short for the Гарантии доставки: at-most-once, at-least-once и правда об exactly-once unit.
</Hook>
