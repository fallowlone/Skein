...
- https://example.com
status: stub
summary: Тест с множественным выбором for unit "Паттерн transactional outbox"
...
<Hook>
This is a quiz-choice for the Паттерн transactional outbox unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Паттерн transactional outbox unit.
</Goal>
