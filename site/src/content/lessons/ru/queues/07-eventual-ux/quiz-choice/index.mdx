...
summary: "Тест с множественным выбором for unit "UX при eventual consistency""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the UX при eventual consistency unit.
</Hook>

<Goal lang="ru>
After this lesson you will be able to apply the concepts from the UX при eventual consistency unit.
</Goal>
