...
- https://example.com
status: ready
summary: Тест с множественным выбором for unit "Гарантии порядка сообщений"
...
<Hook>
This is a quiz-choice for the Гарантии порядка сообщений unit.
</Hook>

<Goal lang="ru">
After this lesson you will be able to apply the concepts from the Гарантии порядка сообщений unit.
</Goal>
