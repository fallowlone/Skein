...
summary: "Тест с множественным выбором for unit "Всё вместе: event-driven service mesh""
estMin: 30
status: ready
prereqs: []
concepts: []
...
<Hook>
This is a quiz-choice for the Всё вместе: event-driven service mesh unit.
</Hook>
