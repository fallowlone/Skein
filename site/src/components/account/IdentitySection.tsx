...
const L = {
  en: {
    ...
    siPropSync: "sync across machines", siProp3: " and back up your progress. No account is required to use Learnvane.",
  ...
  ru: {
    ...
    siPropSync: "синхронизировать между устройствами", siProp3: " и сделать резервную копию прогресса. Аккаунт для работы в Learnvane не обязателен.",
