    ...
    "templates": [
      {
        ...
        "cefrMin": "A1",
        "cefrMax": "A2",
        "pattern": "{subj} ___ ({verb}) every day.",
        "slots": {
          "subj": {
            "pool": "subj3"
          },
        ...
        "rationale": {
          "en": "{subj} is third person singular, so the verb adds -s.",
          "ru": "{subj} — 3-е лицо ед. ч., поэтому глагол получает -s."
        }
      },
      {
        "id": "ps-pl",
        ...
        "deriveKey": "verb-agreement-present",
        "rationale": {
          "en": "{subj} is plural, so the verb stays in its base form.",
          "ru": "{subj} во мн. числе, глагол остаётся в базовой форме."
        }
      }
    ]
  }
