    ...
    "templates": [
      {
        ...
        "cefrMin": "A2",
        "cefrMax": "B1",
        "pattern": "{nounA} is ___ ({adj}) than {nounB}.",
        "slots": {
          "nounA": {
            "pool": "nounA"
          },
        ...
        "deriveKey": "comparative-form",
        "rationale": {
          "en": "Short adjectives add -er; longer ones take 'more'.",
          "ru": "Короткие прилагательные получают -er; длинные — 'more'."
        }
      }
    ]
  }
