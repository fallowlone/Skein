// English-for-Engineers — reading units (seed content).
//
// Each unit mimics a real text an engineer reads on the job. The English is
// authentic (not simplified to death) but every hard word is glossed RU + plain
// English, so an A2 reader can climb without drowning.
