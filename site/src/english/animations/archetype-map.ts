...
import { buildTimelineScene, buildContrastScene, buildTransformScene, buildMapScene, buildBranchScene } from "./editorial/build-scene";
...
export const ARCHETYPE_BUILDERS: Record<string, SceneBuilder> = {
  ...
  "slot-fill":      buildTimelineScene,   // TODO(task6)
  "contrast-pair":  buildContrastScene,
  "transformation": buildTransformScene,
  "scale":          buildTimelineScene,   // TODO(task6)
  "branch":         buildBranchScene,
  "swap":           buildTimelineScene,   // TODO(task6)
  "map":            buildMapScene,
  "highlight":      buildTimelineScene,   // TODO(task6)
};
