...
- [x] **Phase B** — content migration (45/51 units done — networking 12/12, browser 8/8, databases 8/8, observability 8/8, performance 8/8, lone apis/06-graphql-n-plus-one). RESUME at `backend/05-idempotency-retries`.
...
- [x] 07-profiling → 7 lessons, commit `99fd2bb`
  - [x] 01-flame-graph-basics (junior)
  - [x] 02-sampling-vs-instrumenting (middle)
  - [x] 03-profile-types (middle)
  - [x] 04-continuous-profiling (middle)
...
**performance**
- [x] 01-profile-first → 8 lessons, commit `19def4a`
  - [x] 01-why-profile-first (junior)
  - [x] 02-amdahl-and-self-time (middle)
  - [x] 03-measurement-loop (middle)
  - [x] 04-reading-flame-graphs (middle)
  - [x] 05-statistical-baselines (middle)
...
- [x] 04-gc → 6 lessons, commit `1151c68`
  - [x] 01-gc-basics (junior)
  - [x] 02-gc-algorithms (middle)
  - [x] 03-gc-tradeoffs (middle)
  - [x] 04-gc-tuning (middle)
  - [x] 05-gc-internals (senior)
  - [x] 06-gc-production (senior)
- [x] 05-n-plus-one → 6 lessons, commit `0c5ec66` (reconcile after subagent kill)
  - [x] 01-what-is-nplus1 (junior)
  - [x] 02-fix-families (middle)
  - [x] 03-detecting-nplus1 (middle)
  - [x] 04-dataloader-pattern (middle)
  - [x] 05-fan-out-and-redis (middle)
  - [x] 06-nplus1-senior (senior)
- [x] 06-batching → 6 lessons, commit `c56b6b2`
- [x] 07-bundle-budgets → 7 lessons, commit `2343423`
  - [x] 01-what-a-bundle-costs (junior)
  - [x] 02-core-web-vitals (middle)
  - [x] 03-code-splitting (middle)
  - [x] 04-tree-shaking-and-compression (middle)
...
- [ ] backend/05-idempotency-retries  - [ ] caching/03-stampede
